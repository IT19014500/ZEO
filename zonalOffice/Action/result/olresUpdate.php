...
<?php
  $id=$_GET['oid'];
  $sqltq="SELECT * FROM olresult where olid = $id ";
...
if(isset($_POST['submit'])){
    ...
    // if($_SESSION['ref']==2){
        if($Tapcnt<=$Tacnt){
        $update="UPDATE olresult SET scid='$Tscid',YID='$TYID',acnt='$Tacnt',apcnt='$Tapcnt' where olid= $id ";
    ...
    <div id="wrapper">
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="col-md-6">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">O/L Result</h3><br>
