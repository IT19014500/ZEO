...
<?php
  $id=$_GET['id'];
  $sqltq="SELECT * FROM alresult where aid = $id ";
...
if(isset($_POST['submit'])){
    ...
    // if($_SESSION['ref']==2){
        if($Tapcnt<=$Tacnt){
        $update="UPDATE alresult SET scid='$Tscid',YID='$TYID',ssid='$Tssid',acnt='$Tacnt',apcnt='$Tapcnt' where aid= $id ";
    ...
    <div id="wrapper">
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="col-md-6">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">A/L Result</h3><br>
                                        ...
                                        ?>
                                                ...
                                                <div class="form-group">
                                                    <?php
                                                        $sth="";
                                                        $toh="";
                                                        $sqlsfr="SELECT * FROM substream ";
                                                        $resultsfr=$conn->query($sqlsfr);
                                                    ?>
                                                    <label for="Ossid" style="color:#000000;">Stream</label>
                                                    <div class="input-group">
                                                        <div class="input-group-addon"><i class="fa fa-square-o" aria-hidden="true"></i></div>
                                                        <select class="form-control" id = "Ossid1" name="Ossid" placeholder="ENTER STREAM" required>
                                                            <?php
                                                                while($recordsfr = mysqli_fetch_array($resultsfr)){  
                                                                    $sfra=$recordsfr['ssid'];
                                                                    $otc=$recordtq['ssid'];
                                                                    $ensfryer=$recordsfr['name'];
                                                                    $deensfryer = base64_decode($ensfryer);
                                                                    if($sfra==$otc){
                                                                        $sth='selected';
                                                                        $toh=$sfra;
                                                                    }
                                                            ?>
                                                                <option value="<?php echo $sfra; ?>" <?php if($toh==$sfra){echo $sth;}?>><?php echo $deensfryer; ?></option>
                                                            <?php
                                                                }
                                                            ?>
                                                        </select>
                                                ...
                                                <div class="form-group">
                                                    <label for="Oacnt" style="color:#000000;">Sat Count</label>
                                                    <div class="input-group">
                                                        <div class="input-group-addon"><i class="fa fa-square-o" aria-hidden="true"></i></div>
                                                        <input type="text" class="form-control" id = "Oacnt1"  name="Oacnt" value="<?php echo $recordtq['acnt']; ?>" placeholder="Enter Sat Count" required>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="Oapcnt" style="color:#000000;">Passed Count</label>
                                                    <div class="input-group">
                                                        <div class="input-group-addon"><i class="fa fa-square-o" aria-hidden="true"></i></div>
                                                        <input type="text" class="form-control" id = "Oapcnt1"  name="Oapcnt" value="<?php echo $recordtq['apcnt']; ?>" placeholder="Enter Passed Count" required>
                                                    </div>
                                                </div>
