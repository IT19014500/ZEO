    ...
    <?php
        try{
            ...
            if(isset($_GET['id']))
            {
                ...
                $sql = "SELECT * FROM ofiimg WHERE ofisid=$id";
                ...
                if($count==1)
                {
                    ...
                    $current_image = $row['siimg'];
                }
                else
                {
                    //Redirect to manage category with session message;
                    echo "<div class='error'>Sign not found.</div>";
                }
            }
            else
            {
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="col-lg-2 col-sm-4 col-xs-12">
                    <a href = "../../htmlPages/AdminPannel/signCollection/signpic/office.php"><button class="btn btn-block btn-primary">Click to Back</button></a>
                </div>
                <br><br>
                ...
                <div class="col-md-6">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Update Sign</h3><br>
                            <div class="row">
                                        ...
                                        <?php
                                            try{
                                                if($current_image != "")
                                                {
                                                    //Display the image
                                            ?>
                                                    <img src="<?php echo "../../images/ofisign/$current_image"; ?>" alt="No Image" width="150px">
                                            <?php
                                                }
                                                else
                                                {
                                        ...
                                        try{
                                            if(isset($_POST['submit']))
                                            {
                                                ...
                                                if($current_im != "")
                                                    {
                                                        ...
                                                        //Rename the image 
                                                        $current_im = "UOFI_Sign_Photo_".rand(000,999).'.'.$ext;

                                                        $source_path = $_FILES['image']['tmp_name'];

                                                        $destination_path = "../../images/ofisign/".$current_im;

                                                        //Finally upload the Image
                                                        $upload = move_uploaded_file($source_path, $destination_path);
                                                        //Image is Availabe. So remove it
                                                        $path = "../../images/ofisign/".$current_image;
                                                        //Remove the Image
                                                        $remove = unlink($path);
                                                ...
                                                ?>
                                                    <Script>
                                                        alert("Sign Updated!");
                                                        location= '../../htmlPages/AdminPannel/signCollection/signpic/office.php';
                                                    </Script>
                                                <?php
                                                }
                                                else
