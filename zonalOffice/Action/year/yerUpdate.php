...
<?php
  $id=$_GET['id'];
  $sqltq="SELECT * FROM yeart where YID = $id ";
...
<?php
    if(isset($_POST['submit'])){
        ...
        $update="UPDATE yeart SET yer='$Tyer' where YID='$id' ";
    ...
    <div id="wrapper">
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                ...
                <br><br>
                <h1 style="color:#000000;text-align:center;"><strong><em>Update Year</em></strong></h1><br>
                <div class="row">
                    <div class="col-md-6">
                        <div class="white-box">
                                ...
                                <div class="col-sm-12 col-xs-12">
                                    <form action="" method="post">
                                        ...
                                        <div class="form-group">
                                            <label style="color:#000000;" for="Oyer">Year</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-square-o" aria-hidden="true"></i></div>
                                                <input type="text" class="form-control" id = "Oyer1"  name="Oyer" value="<?php echo $enyer; ?>" placeholder="ENTER YEAR" required>
                                            </div>
                                        </div>
                                        <?php
                                            }
