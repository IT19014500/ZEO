...
<?php
    try{
        ...
        if(isset($_GET['id']))
        {
            ...
            $sql = "SELECT * FROM frnttbl WHERE frid=$id";
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="col-lg-2 col-sm-4 col-xs-12">
                    <a href = "../../htmlPages/AdminPannel/indexAdmin/downslider.php"><button class="btn btn-block btn-primary">Click to Back</button></a>
                </div>
                <br><br>
                <h1 style="color:#000000;text-align:center;"><strong><em>Update Down Slider</em></strong></h1><br>
                <div class="row">
                <div class="col-md-6">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Down Slider</h3><br>
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        ?>
                                                <div class="form-group">
                                                    <label for="OfrName" style="color:#000000;">Slider Title</label>    
                                                    <div class="input-group">
                                                        <div class="input-group-addon"><i class="fa fa-square-o" aria-hidden="true"></i></div>
                                                        <input type="text" class="form-control" id = "OfrName1"  name="OfrName" value="<?php echo $deenbname; ?>" placeholder="ENTER TITLE" >        
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="Ofrdes" style="color:#000000;">Description</label>
                                                    <div class="input-group">
                                                        <div class="input-group-addon"><i class="fa fa-square-o" aria-hidden="true"></i></div>
                                                        <input type="text" class="form-control" id = "Ofrdes1"  name="Ofrdes" value="<?php  echo $deenbtitle; ?>" placeholder="ENTER DESCRIPTION" >
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <?php
                                                        try{
                                                            if($current_image != "")
                                                            {
                                                                //Display the image
                                                                ?>
                                                                <img src="<?php echo "../../images/index/$current_image"; ?>" alt="No Image" width="150px">
                                                                <?php
                                                            }
                                                            else
                                                            {
                                        ...
                                        <?php
                                            try{
                                                if(isset($_POST['submit']))
                                                {
                                                    ...
                                                    if($current_im != "")
                                                        {
                                                            ...
                                                            //Rename the image 
                                                            $current_im = "UIND_Photo_".rand(000,999).'.'.$ext;

                                                            $source_path = $_FILES['image']['tmp_name'];

                                                            $destination_path = "../../images/index/".$current_im;

                                                            //Finally upload the Image
                                                            $upload = move_uploaded_file($source_path, $destination_path);
                                                            //Image is Availabe. So remove it
                                                            $path = "../../images/index/".$current_image;
                                                            //Remove the Image
                                                            $remove = unlink($path);
                                                    ...
                                                    ?>
                                                            <Script>
                                                                alert("Down Slide Updated!");
                                                                location= '../../htmlPages/AdminPannel/indexAdmin/downslider.php';
                                                            </Script>
                                                    <?php
                                                    }
                                                    else
