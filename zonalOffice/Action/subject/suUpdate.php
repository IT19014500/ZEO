...
<?php
  $id=$_GET['id'];
  $sqltq="SELECT * FROM subject where suID = $id ";
...
<?php
    if(isset($_POST['submit'])){
        ...
        $update="UPDATE subject SET name='$TfullNamevar',caid='$Tcaid',ssid='$Tssid' where suID='$otid' ";
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="col-lg-2 col-sm-4 col-xs-12">
                    <a href = "../../htmlPages/AdminPannel/subject.php"><button class="btn btn-block btn-primary">Click to Back</button></a>
                </div>
                <br><br>
                <h1 style="color:#000000;text-align:center;"><strong><em>Update Subject</em></strong></h1><br>
                <div class="row">
                    <div class="col-md-6">
                        <div class="white-box">
                                ...
                                <div class="col-sm-12 col-xs-12">
                                    <form action="" method="post">
                                        ...
                                        <div class="form-group">
                                            <label style="color:#000000;" for="OfullName">Subject Name</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-square-o" aria-hidden="true"></i></div>
                                                <input type="text" class="form-control" id = "OfullName1"  name="OfullName" value="<?php echo $deenname; ?>" placeholder="ENTER SUBJECT NAME" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <?php
                                                ...
                                                $bocenna="";
                                                $debocenna="";
                                                $sqlpct="SELECT * FROM subcategory ";
                                                $resultpct=$conn->query($sqlpct);
                                            ?>
                                            <label style="color:#000000;" for="Ocaid">Subject Category</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-square-o" aria-hidden="true"></i></div>
                                                <select class="form-control" id = "Ocaid1" name="Ocaid" required>
                                                    ...
                                                    ?>
                                                        <option value="<?php echo $boc; ?>" <?php if($bood==$boc){echo $zzc;}?>><?php echo $debocenna; ?></option>
                                                    <?php
                                                        }
                                                    ?>
                                                </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            ?>
                                            <label style="color:#000000;" for="Ossid">Subject Stream</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-square-o" aria-hidden="true"></i></div>
