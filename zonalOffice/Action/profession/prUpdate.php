...
<?php
  $id=$_GET['id'];
  $sqltq="SELECT * FROM profession where proid = '$id' ";
...
<?php
    if(isset($_POST['submit'])){
        ...
        $update="UPDATE profession SET name='$Tnamevar',des='$TaddressTvar' where proid='$otid' ";
...
<Script>
    alert("Profession Details Updated!");
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="col-lg-2 col-sm-4 col-xs-12">
                    <a href = "../../htmlPages/AdminPannel/professions.php"><button class="btn btn-block btn-primary">Click to Back</button></a>
                </div>
                <br><br>
                <h1 style="color:#000000;text-align:center;"><strong><em>Update Profession</em></strong></h1><br>
                <div class="row">
                <div class="col-md-6">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Profession</h3><br>
                                ...
                                <div class="col-sm-12 col-xs-12">
                                    <form action="" method="post">
                                        ...
                                        <div class="form-group">
                                            <label style="color:#000000;" for="Oname">PROFESSION NAME</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-square-o" aria-hidden="true"></i></div>
                                                <input type="text" class="form-control" id = "Oname1"  name="Oname" value="<?php echo $deenname; ?>"  required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="color:#000000;" for="OaddressT">DESCRIPTION</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-square-o" aria-hidden="true"></i></div>
                                                <input type="text" class="form-control" id = "OaddressT1"  name="OaddressT" value="<?php echo $deendes; ?>"  required>
                                            </div>
                                        </div>
                                        <?php
                                            }
