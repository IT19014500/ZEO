...
<?php
    try{
        ...
        if(isset($_GET['id']))
        {
            ...
            $sql = "SELECT * FROM hobtbl WHERE hoid=$id";
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="col-lg-2 col-sm-4 col-xs-12">
                    <a href = "../../htmlPages/AdminPannel/branchAdmin/branchpic/hobDetail.php"><button class="btn btn-block btn-primary">Click to Back</button></a>
                </div>
                <br><br>
                ...
                <div class="col-md-6">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">HOB Details</h3><br>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        ?>
                                                <div class="form-group">
                                                    <label for="Ohname" style="color:#000000;">Head of the department name</label>
                                                    <div class="input-group">
                                                        <div class="input-group-addon"><i class="fa fa-square-o" aria-hidden="true"></i></div>
                                                        <input type="text" class="form-control" id = "Ohname1"  name="Ohname" value="<?php echo $deenbname; ?>" placeholder="ENTER HOD NAME" required>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <div class="input-group-addon"><i class="fa fa-square-o" aria-hidden="true"></i></div>
                                                        <input type="text" class="form-control" id = "Oiden1"  name="Oiden" value="<?php  echo $deenbtiden; ?>" placeholder="ENTER NIC NUMBER" required>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <?php
                                                        try{
                                                            if($current_image != "")
                                                            {
                                                                //Display the image
                                                                ?>
                                                                <img src="<?php echo "../../images/hobProfile/$current_image"; ?>" alt="No Image" width="150px">
                                                                <?php
                                                            }
                                                            else
                                                            {
                                            ...
                                            try{
                                                if(isset($_POST['submit']))
                                                {
                                                    ...
                                                    if($current_im != "")
                                                        {
                                                            ...
                                                            $destination_path = "../../images/hobProfile/".$current_im;
                                                    ...
                                                    ?>
                                                            <Script>
                                                                alert("HOD Updated!");
                                                                location= '../../htmlPages/AdminPannel/branchAdmin/branchpic/hobDetail.php';
                                                            </Script>  
                                                    <?php
                                                    }
                                                    else
