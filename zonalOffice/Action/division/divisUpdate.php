...
<?php
  $id=$_GET['id'];
  $sqltq="SELECT * FROM division where divcode = '$id' ";
...
<?php
    if(isset($_POST['submit'])){
        ...
        $update="UPDATE division SET divisionname='$Tdivisionnamevar',distcode='$Tdistcodevar',zonecode='$Tzonecodevar' where divcode ='$id' ";
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="col-lg-2 col-sm-4 col-xs-12">
                    <a href = "../../htmlPages/AdminPannel/division.php"><button class="btn btn-block btn-primary">Click to Back</button></a>
                </div>
                <br><br>
                                    ...
                                    <form action="" method="post">
                                        <?php
                                            while($recordtq = mysqli_fetch_array($resulttq)){
                                                $endivisionname = $recordtq['divisionname'];
                                        ...
                                        <div class="form-group">
                                            <label style="color:#000000;" for="Ozone">Division</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-square-o" aria-hidden="true"></i></div>
                                                <input type="text" class="form-control" id = "Odivisionname1"  name="Odivisionname" value="<?php echo $deendivisionname; ?>" placeholder="ENTER DIVISION NAME" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
