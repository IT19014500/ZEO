...
<?php
  $id=$_GET['id'];
  $sqltq="SELECT * FROM substream where ssid = $id ";
...
<?php
    if(isset($_POST['submit'])){
        ...
        $update="UPDATE substream SET name='$TfullNamevar' where ssid='$otid' ";
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="col-lg-2 col-sm-4 col-xs-12">
                    <a href = "../../htmlPages/AdminPannel/substreams.php"><button class="btn btn-block btn-primary">Click to Back</button></a>
                </div>
                <br><br>
                <h1 style="color:#000000;text-align:center;"><strong><em>Update Subject Stream</em></strong></h1><br>
                <div class="row">
                    <div class="col-md-6">
                        <div class="white-box">
                                ...
                                <div class="col-sm-12 col-xs-12">
                                    <form action="" method="post">
                                        ...
                                        <div class="form-group">
                                            <label style="color:#000000;" for="OfullName">Subject Stream</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-square-o" aria-hidden="true"></i></div>
                                                <input type="text" class="form-control" id = "OfullName1"  name="OfullName" value="<?php echo $deenname; ?>" placeholder="ENTER SUBJECT STREAM" required>
                                            </div>
                                        </div>
                                        <?php
                                            }
