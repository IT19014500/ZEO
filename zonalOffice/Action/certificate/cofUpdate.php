...
<?php
    try{
        $id=$_GET['id'];
        $sqltq="SELECT * FROM coftbl where cofid = $id ";
        $resulttq=$conn->query($sqltq);
    }catch(Exception $e) {
        echo "C. Officer Reading Failed!";
    }
?> 
<?php
    try{
        if(isset($_POST['submit'])){
            ...
            $update="UPDATE coftbl SET uname='$Tunamevar',scid='$Tsc' where cofid=$id ";

            if($conn-> query($update)==TRUE){
    ?>
                <Script>
                    alert("Certificate Officer Details Updated!");
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="col-lg-2 col-sm-4 col-xs-12">
                    <a href = "../../htmlPages/AdminPannel/certificate/cofSelect.php"><button class="btn btn-block btn-primary">Click to Back</button></a>
                </div>
                <br><br>
                ...
                <div class="col-md-6">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Certificate Admin</h3><br>
                                        ...
                                        <?php
                                            try{
                                                ...
                                                <div class="form-group">
                                                    <label for="Ouname" style="color:#000000;">Username</label>
                                                    <label for="Ouname" class="form-control"><?php echo $deenuname; ?></label>
                                                    <input type="hidden" class="form-control" id = "Ouname1"  name="Ouname" value="<?php echo $deenuname; ?>" placeholder="ENTER USER NAME" required>
                                                </div>
                                                <div class="form-group">
                                                    <?php
                                                        $jbv="";
                                                        $hrood="";
                                                        $sqlmst="SELECT * FROM school ";
                                                        $resultmst=$conn->query($sqlmst);
                                                    ?> 
                                                    <label for="Oscid" style="color:#000000;">School</label>
                                                    <div class="input-group" style="width:445px;">
                                                ...
                                                <?php
                                                    echo "<select id='Oscid1' name='Oscid' class='form-control'>";
                                                        ...
                                                        ?>
                                                        <option value="<?php echo $msix; ?>"  <?php if($hrood==$msix){echo $jbv;}?>><?php echo $deenkklmnams; ?></option>
                                                        <?php
                                                    }
                                                    echo "</select>";
                                                    echo "</div><br>";
