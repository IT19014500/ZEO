...
<?php
    try{
        $id=$_GET['id'];
        $sqltq="SELECT * FROM markadmin where username = '$id' ";
...
<?php
    try{
        if(isset($_POST['submit'])){
            ...
            $update="UPDATE markadmin SET scid='$Tsc' where username='$id' ";
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="col-lg-2 col-sm-4 col-xs-12">
                    <a href = "../../htmlPages/AdminPannel/markadmAd.php"><button class="btn btn-block btn-primary">Click to Back</button></a>
                </div>
                <br><br>
                ...
                <div class="col-md-6">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Marking Admin</h3><br>
                            <div class="row">
                                        ...
                                        <?php
                                            try{
                                                while($recordtq = mysqli_fetch_array($resulttq)){
                                                    $ennmbv = $recordtq['username'];
                                                    $deennmbv = base64_decode($ennmbv); 
                                            ?>
                                            <div class="form-group">
                                                <label for="" style="color:#000000;">Username</label><br>
                                                <label for="" class='form-control'><?php echo $deennmbv;?></label>
                                            </div>
                                            <div class="form-group">
                                            <?php
                                                $jbv="";
                                            ...
                                            ?>
                                                <label for="" style="color:#000000;">School</label><br>
                                            ...
                                            <?php
                                                ...
                                                while($recordersc = mysqli_fetch_array($resultersc)){  
                                                    $msix=$recordersc['scid'];
                                                    $kklm=$recordtq['scid'];
                                                    $enkklmnams = $recordersc['name'];
