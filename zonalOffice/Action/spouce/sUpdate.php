...
<?php
    try{
        ...
        echo "Spouce List Loading Failed!";
    }
?> 
...
<?php
    try{
        if(isset($_POST['submit'])){
            ...
            if($_SESSION['ref']==1){
                $update="UPDATE tspouce SET spname='$Tspnamevar',spscl='$Tspsclvar' where tid=$Ttid ";
            }elseif($_SESSION['ref']==5){
                $update="INSERT INTO tspoucetmp(tid,spname,spscl)VALUES('$Ttid','$Tspnamevar','$Tspsclvar') ";
            }
    ...
    ?>
                <Script>
                    ...
                    ?>
                        alert("Spouce Details will be Updated After Zonal Head Approval!");
                    <?php
                        }
                    ?>
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="col-lg-2 col-sm-4 col-xs-12">
                    <a href = '../../htmlPages/clientSide/spouceList.php'><button class="btn btn-block btn-primary">Click to Back</button></a>
                </div>
                <br><br>
                <h1 style="color:#000000;text-align:center;"><strong><em>Update Spouce Details</em></strong></h1><br>
                <div class="row">
                <div class="col-md-6">
                        <div class="white-box">
                                        ...
                                        <?php
                                            try{
                                                while($recordtq = mysqli_fetch_array($resulttq)){
                                                    $hlj = $recordtq['tid'];
                                                    $enspname = $recordtq['spname'];
                                                    $enspscl = $recordtq['spscl'];

                                                    $deenspname = base64_decode($enspname);          
                                                    $deenspscl = base64_decode($enspscl);
                                            ?>
                                            <div class="form-group">
                                                <label style="color:#000000;" for="Ospname">Spouce Name</label>
                                                <div class="input-group">
                                                    <div class="input-group-addon"><i class="fa fa-square-o" aria-hidden="true"></i></div>
                                                    <input type="text" class="form-control" id = "Ospname1"  name="Ospname" value="<?php echo $deenspname; ?>" placeholder="ENTER SPOUCE NAME" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label style="color:#000000;" for="Ospscl">Spouce School</label>
                                                <div class="input-group">
                                                    <div class="input-group-addon"><i class="fa fa-square-o" aria-hidden="true"></i></div>
                                                    <input type="text" class="form-control" id = "Ospscl1"  name="Ospscl" value="<?php echo $deenspscl; ?>" placeholder="ENTER SPOUCE SCHOOL" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <?php
