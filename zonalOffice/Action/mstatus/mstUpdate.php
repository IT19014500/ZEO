...
<?php
  $id=$_GET['id'];
  $sqltq="SELECT * FROM mstatus where mrid = '$id' ";
...
<?php
    if(isset($_POST['submit'])){
        ...
        $update="UPDATE mstatus SET status='$Tstatusvar',descri='$Tdescrivar' where mrid='$otid' ";

        if($conn-> query($update)==TRUE){
?>

<Script>
    alert("Marital Details Updated!");
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="col-lg-2 col-sm-4 col-xs-12">
                    <a href = "../../htmlPages/AdminPannel/maritaldAdd.php"><button class="btn btn-block btn-primary">Click to Back</button></a>
                </div>
                <br><br>
                <h1 style="color:#000000;text-align:center;"><strong><em>Update Marital Status</em></strong></h1><br>
                <div class="row">
                    <div class="col-md-6">
                        <div class="white-box">
                                ...
                                <div class="col-sm-12 col-xs-12">
                                    <form action="" method="post">
                                        ...
                                        <div class="form-group">
                                            <label style="color:#000000;" for="Ostatus">Marital Status</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-square-o" aria-hidden="true"></i></div>
                                                <input type="text" class="form-control" id = "Ostatus1"  name="Ostatus" value="<?php echo $deenstatus; ?>" placeholder="ENTER STATUS" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-square-o" aria-hidden="true"></i></div>
                                                <input type="text" class="form-control" id = "Odescri1"  name="Odescri" value="<?php echo $deendescri; ?>" placeholder="ENTER DESCRIPTION" required>
                                            </div>
                                        </div>
                                        <?php
                                            }
