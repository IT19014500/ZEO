...
<?php
    try{
        ...
        echo "Activity List Loading Failed!";
    }
?> 
<?php
    try{
        if(isset($_POST['submit'])){
            ...
            if($_SESSION['ref']==1){
                $update="UPDATE extractvi SET extAct='$TextActvar',tid='$Ttid' where eid=$id ";
            }elseif($_SESSION['ref']==5){
                $update="INSERT INTO extractvitmp(eid,extAct,tid)VALUES('$id','$TextActvar','$Ttid')";
            }
    ...
    ?>
                <Script>
                    <?php
                        if($_SESSION['ref']==1){
                    ?>
                        alert("Extra Activity Details Updated!");
                    <?php
                        }elseif($_SESSION['ref']==5){
                    ?>
                        alert("Extra Activity Details will be Updated After Zonal Head Approval!");
                    <?php
                        }
                    ?>
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="col-lg-2 col-sm-4 col-xs-12">
                    <a href = '../../htmlPages/clientSide/extraActivityList.php'><button class="btn btn-block btn-primary">Click to Back</button></a>
                </div>
                <br><br>
                <h1 style="color:#000000;text-align:center;"><strong><em>Update Extra Activity Details</em></strong></h1><br>
                <div class="row">
                <div class="col-md-6">
                        <div class="white-box">
                                        ...
                                        <?php
                                            try{
                                                while($recordtq = mysqli_fetch_array($resulttq)){
                                                    $hlj = $recordtq['tid'];
                                                    $enextAct = $recordtq['extAct'];
                                                    $deenextAct = base64_decode($enextAct);
                                            ?>
                                            <div class="form-group">
                                                <label style="color:#000000;" for="OextAct">Extra Activity</label>
                                                <div class="input-group">
                                                    <div class="input-group-addon"><i class="fa fa-square-o" aria-hidden="true"></i></div>
                                                    <input type="text" class="form-control" id = "OextAct1"  name="OextAct" value="<?php echo $deenextAct; ?>" placeholder="EXTRA ACTIVITY" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <?php
                                                ...
                                                ?>
                                                <label style="color:#000000;" for="OextAct">Teacher NIC</label>
                                                <div class="input-group">
                                                    <div class="input-group-addon"><i class="fa fa-square-o" aria-hidden="true"></i></div>
