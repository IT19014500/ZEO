...
<?php
  $id=$_GET['id'];
  $sqltq="SELECT * FROM district where distcode = '$id' ";
...
<?php
    if(isset($_POST['submit'])){
        ...
        $update="UPDATE district SET distname='$Tdistnamevar',procode='$Tprocodevar' where distcode ='$odistcode' ";
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="col-lg-2 col-sm-4 col-xs-12">
                    <a href = "../../htmlPages/AdminPannel/district.php"><button class="btn btn-block btn-primary">Click to Back</button></a>
                </div>
                <br><br>
                <h1 style="color:#000000;text-align:center;"><strong><em>Update District</em></strong></h1><br>
                <div class="row">
                    <div class="col-md-6">
                        <div class="white-box">
                                    ...
                                    <form action="" method="post">
                                        <?php
                                            while($recordtq = mysqli_fetch_array($resulttq)){
                                                $endistname = $recordtq['distname'];
                                                $deendistname = base64_decode($endistname);    
                                                $enprocode = $recordtq['procode'];
                                                $deenprocode = base64_decode($enprocode);
                                        ?>
                                        <div class="form-group">
                                            <label style="color:#000000;" for="Odistname">District</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-square-o" aria-hidden="true"></i></div>
                                                <input type="text" class="form-control" id = "Odistname1"  name="Odistname" value="<?php echo $deendistname; ?>" placeholder="ENTER DISTRICT NAME" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="color:#000000;" for="Oprocode">Province code</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-square-o" aria-hidden="true"></i></div>
