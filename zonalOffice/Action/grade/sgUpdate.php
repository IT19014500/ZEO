...
<?php
  $id=$_GET['id'];
  $sqltq="SELECT * FROM serandgrade where sgid = $id ";
...
<?php
    if(isset($_POST['submit'])){
        ...
        $update="UPDATE serandgrade SET grade='$Tgradevar',descri='$Tdescrivar' where sgid='$otid' ";
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="col-lg-2 col-sm-4 col-xs-12">
                    <a href = "../../htmlPages/AdminPannel/Grade.php"><button class="btn btn-block btn-primary">Click to Back</button></a>
                </div>
                <br><br>
                <h1 style="color:#000000;text-align:center;"><strong><em>Update Teacher Grade</em></strong></h1><br>
                <div class="row">
                    <div class="col-md-6">
                        <div class="white-box">
                                    ...
                                    <form action="" method="post">
                                        <?php
                                            while($recordtq = mysqli_fetch_array($resulttq)){
                                                $engrade=$recordtq['grade'];
                                                $deengrade = base64_decode($engrade);
                                        ?>
                                        <div class="form-group">
                                            <label style="color:#000000;" for="Ograde">Grade</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-square-o" aria-hidden="true"></i></div>
                                                <input type="text" class="form-control" id = "Ograde1"  name="Ograde" value="<?php echo $deengrade; ?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <?php 
                                            ...
                                            ?>
                                            <label style="color:#000000;" for="Odescri">Select Category</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-square-o" aria-hidden="true"></i></div>
                                                <select class="form-control" id = "Odescri1" name="Odescri" required>
                                                    <option value="Principle" <?php echo $cap1 ?>>Principle</option>
                                                    <option value="Not Principle" <?php echo $cap2 ?>>Not Principle</option>
                                                </select>
                                            </div>
                                        </div>
                                        <?php
