...
<?php
  $id=$_GET['id'];
  $sqltq="SELECT * FROM classt where clid = $id ";
...
<?php
    if(isset($_POST['submit'])){
        ...
        $update="UPDATE classt SET class='$Tclassvar',descri='$Tdescrivar'  where clid='$otid' ";
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="col-lg-2 col-sm-4 col-xs-12">
                    <a href = "../../htmlPages/AdminPannel/class.php"><button class="btn btn-block btn-primary">Click to Back</button></a>
                </div>
                <br><br>
                <h1 style="color:#000000;text-align:center;"><strong><em>Update Class Number</em></strong></h1><br>
                <div class="row">
                    <div class="col-md-6">
                        <div class="white-box">
                                    ...
                                    <form action="" method="post">
                                        <?php
                                            while($recordtq = mysqli_fetch_array($resulttq)){
                                                $enclass = $recordtq['class'];
                                                $endescri = $recordtq['descri'];
                                                $deenclass = base64_decode($enclass);
                                                $deendescri = base64_decode($endescri);             
                                        ?>
                                        <div class="form-group">
                                            <label style="color:#000000;" for="Oclass">Class</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-square-o" aria-hidden="true"></i></div>
                                                <input type="text" class="form-control" id = "Oclass1"  name="Oclass" value="<?php echo $deenclass; ?>" placeholder="ENTER CLASS" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
