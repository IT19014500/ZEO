...
<?php
  $id=$_GET['id'];
  $sqltq="SELECT * FROM classtbllet where cleid = $id ";
...
<?php
    if(isset($_POST['submit'])){
        ...
        $update="UPDATE classtbllet SET clid='$Tclid',letter='$Tlettervar'  where cleid=$otid ";
...
<Script>
    alert("Class Letter Details Updated!");
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="col-lg-2 col-sm-4 col-xs-12">
                    <a href = "../../htmlPages/AdminPannel/classLetter.php"><button class="btn btn-block btn-primary">Click to Back</button></a>
                </div>
                <br><br>
                <h1 style="color:#000000;text-align:center;"><strong><em>Update Class Letter</em></strong></h1><br>
                <div class="row">
                    <div class="col-md-6">
                        <div class="white-box">
                                ...
                                <div class="col-sm-12 col-xs-12">
                                    <form action="" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            ?>
                                            <label style="color:#000000;" for="Oclass">Class Number</label>
                                            <div class="input-group">
                                                ...
                                                <select class="form-control" id = "Oclid1" name="Oclid" required>
                                                    ...
                                                    ?>
                                                        <option value="<?php echo $clsid; ?>" <?php if($bbcd==$clsid){echo $bbc;}?>><?php echo $declsnm; ?></option>
                                                    <?php
                                                        }
                                                    ?>
                                                </select>
                                        ...
                                        <div class="form-group">
                                            <label style="color:#000000;" for="Oletter">Class Letter</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-square-o" aria-hidden="true"></i></div>
                                                <input type="text" class="form-control" id = "Oletter1"  name="Oletter" value="<?php echo $deenletter; ?>" placeholder="ENTER CLASS LETTER" required>
                                            </div>
                                        </div>
                                        <?php
                                            }
