...
if(isset($_POST['submit'])){
    ...
    $crdscid=$_POST['Ocrdscid'];
    $proidp=$_POST['Ocrdproid'];
    $Tcrdcnt=$_POST['Ocrdcnt'];

    if($_SESSION['ref']==2){
        $update="UPDATE prcardret SET cnt='$Tcrdcnt' where pcrid= $id ";
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form action="" method="post">
                                        ...
                                        ?>
                                                <input type="hidden" class="form-control" id = "Ocrdscid1"  name="Ocrdscid" value="<?php echo $recordtq['scid']; ?>" required>
                                                <input type="hidden" class="form-control" id = "Ocrdproid1"  name="Ocrdproid" value="<?php echo $recordtq['proid']; ?>" required>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id = "Ocrdcnt1"  name="Ocrdcnt" value="<?php echo $recordtq['cnt']; ?>" placeholder="Enter Approved Count" required>
                                            </div>
                                        </div>
