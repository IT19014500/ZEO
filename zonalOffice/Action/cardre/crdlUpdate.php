...
if(isset($_POST['submit'])){
    ...
    $Tcrdcnt=$_POST['Ocrdcnt'];
    $sclp=$_POST['Ocrdscid'];
    $suidp=$_POST['OcrdsuID'];

    if($_SESSION['ref']==2){
        $update="UPDATE cardret SET cnt='$Tcrdcnt' where crid= $id ";
    }elseif($_SESSION['ref']==1){
        $update="INSERT INTO cardrettmp(crid,scid,suID,cnt)VALUES('$id','$sclp','$suidp','$Tcrdcnt')";
    }
...
if($_SESSION['ref']==1){
?>
    alert("Cardre Details will Update After Zonal Head Approval!");
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="col-lg-2 col-sm-4 col-xs-12">
                    <a href = "../../htmlPages/AdminPannel/cardre/priCardre.php"><button class="btn btn-block btn-primary">Click to Back</button></a>
                </div>
                <?php
                    }elseif($_SESSION['ref']==2){
                ?>
                ...
                <div class="col-md-6">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Carder Details</h3><br>
                                    ...
                                    <form action="" method="post">
                                        ...
                                        <!-- <div class="form-group">
                                            ...
                                            <div class="input-group"> -->
                                                ...
                                                <input type="hidden" class="form-control" id = "crdscid1"  name="Ocrdscid" value="<?php echo $recordtq['scid']; ?>" required>
                                            <!-- </div>
                                        </div> -->
                                        <!-- <div class="form-group">
                                            ...
                                            <div class="input-group"> -->
                                                ...
                                                <!-- <div class="input-group-addon"><i class="fa fa-square-o" aria-hidden="true"></i></i></div> -->
                                                <input type="hidden" class="form-control" id = "crdsuID1"  name="OcrdsuID" value="<?php echo $recordtq['suID']; ?>" required>
                                            <!-- </div>
                                        </div> -->
                                        <div class="form-group">
                                            <label for="Ocrdcnt" style="color:#000000;">Approved Count</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-square-o" aria-hidden="true"></i></div>
                                                <input type="text" class="form-control" id = "crdcnt1"  name="Ocrdcnt" value="<?php echo $recordtq['cnt']; ?>" placeholder="ENTER Approved Count" required>
                                            </div>
                                        </div>
