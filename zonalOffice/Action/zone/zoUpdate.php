...
<?php
  $id=$_GET['id'];
  $sqltq="SELECT * FROM zonet where zid = $id ";
...
<?php
    if(isset($_POST['submit'])){
        ...
        $Tzonevar = base64_encode($Tzone);
        $Tzcodevar = base64_encode($Tzcode);
        $Tdiscvar = base64_encode($Tdisc);

        $update="UPDATE zonet SET zone='$Tzonevar',zonecode='$Tzcodevar',distcode='$Tdiscvar' where zid ='$otid' ";
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="col-lg-2 col-sm-4 col-xs-12">
                    <a href = "../../htmlPages/AdminPannel/zone.php"><button class="btn btn-block btn-primary">Click to Back</button></a>
                </div>
                <br><br>
                <h1 style="color:#000000;text-align:center;"><strong><em>Update Zone</em></strong></h1><br>
                <div class="row">
                    <div class="col-md-6">
                        <div class="white-box">
                                    ...
                                    <form action="" method="post">
                                        <?php
                                            while($recordtq = mysqli_fetch_array($resulttq)){
                                                $enzone = $recordtq['zone'];
                                                $deenzone = base64_decode($enzone);    
                                        ...
                                        <div class="form-group">
                                            <label style="color:#000000;" for="Ozone">Zone</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-square-o" aria-hidden="true"></i></div>
                                                <input type="text" class="form-control" id = "Ozone1"  name="Ozone" value="<?php echo $deenzone; ?>" placeholder="ENTER SCHOOL NAME" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="color:#000000;" for="Ozone">Zone code</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-square-o" aria-hidden="true"></i></div>
                                                <input type="text" class="form-control" id = "Ozcode1"  name="Ozcode" value="<?php echo $deenzonecode; ?>" placeholder="ENTER ZONE CODE" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="color:#000000;" for="Ozone">District code</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-square-o" aria-hidden="true"></i></div>
                                                <input type="text" class="form-control" id = "Odisc1"  name="Odisc" value="<?php echo $deendistcode; ?>" placeholder="ENTER DISTRICT CODE" required>
                                            </div>
                                        </div>
                                        <?php
                                            }
