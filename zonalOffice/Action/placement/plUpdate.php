...
<?php
  $id=$_GET['id'];
  $sqltq="SELECT * FROM plcategory where plid = '$id' ";
...
if(isset($_POST['submit'])){
    ...
    $update="UPDATE plcategory SET name='$Tnamevar',descri='$Tdescrivar' where plid='$otid' ";
...
<Script>
    alert("Placement Details Updated!");
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="col-lg-2 col-sm-4 col-xs-12">
                    <a href = "../../htmlPages/AdminPannel/placementc.php"><button class="btn btn-block btn-primary">Click to Back</button></a>
                </div>
                <br><br>
                <h1 style="color:#000000;text-align:center;"><strong><em>Update Placement</em></strong></h1><br>
                <div class="row">
                    <div class="col-md-6">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Placement</h3><br>
                                ...
                                <div class="col-sm-12 col-xs-12">
                                    <form action="" method="post">
                                        ...
                                        <div class="form-group">
                                            <label style="color:#000000;" for="Oname">PLACEMENT NAME</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-square-o" aria-hidden="true"></i></div>
                                                <input type="text" class="form-control" id = "Oname1"  name="Oname" value="<?php echo $deenname; ?>" placeholder="ENTER PLACEMENT NAME" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
