...
<?php
  $id=$_GET['id'];
  $sqltq="SELECT * FROM examdutyprof where eid = $id ";
...
if(isset($_POST['submit'])){
    ...
    $Tprovar = base64_encode($Tpro);

    $update="UPDATE examdutyprof SET profession='$Tprovar' where eid =$otid ";
...
<Script>
    alert("Exam Duty Proffession Details Updated!");
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="col-lg-2 col-sm-4 col-xs-12">
                    <a href = "../../htmlPages/AdminPannel/ExamDuty/dutyProfession.php"><button class="btn btn-block btn-primary">Click to Back</button></a>
                </div>
                <br><br>
                                    ...
                                    <form action="" method="post">
                                        <?php
                                            while($recordtq = mysqli_fetch_array($resulttq)){
                                                $enpro = $recordtq['profession'];
                                                $deenpro = base64_decode($enpro);            
                                        ?>
                                        <div class="form-group">
                                            <label style="color:#000000;" for="Opro">Profesion Name</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-square-o" aria-hidden="true"></i></div>
                                                <input type="text" class="form-control" id = "Opro1"  name="Opro" value="<?php echo $deenpro; ?>" placeholder="ENTER PROFESSION NAME" required>
                                            </div>
                                        </div>
                                        <?php
                                            }
