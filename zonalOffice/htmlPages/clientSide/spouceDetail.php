...
<?php
    try{
        if(isset($_POST['submit'])){
            ...
            $Tspname=$_POST['Ospname'];
            $Tspscl=$_POST['Ospscl'];

            $Ttid=$_POST['Otid'];
            
            $Tspnamevar = base64_encode($Tspname);
            $Tspsclvar = base64_encode($Tspscl);

            $sqlspd="SELECT * FROM tspouce WHERE tid = $Ttid";
            $resultspd=$conn->query($sqlspd);
                
            while($recordspd = mysqli_fetch_array($resultspd)){  
                $spdaply = true;
            }
            if($spdaply == false){
            $add="INSERT INTO tspouce(tid,spname,spscl)VALUES('$Ttid','$Tspnamevar','$Tspsclvar')";
            }else{
?>
                <Script>
                    alert("Already Added Your Spouce!");
                    location='spouceDetail.php';
                </Script>
<?php
            }
            ...
            <div class="container-fluid">
                <!-- /row -->
                    <div class="col-lg-2 col-sm-4 col-xs-12">
                        <a href="spouceList.php"><button style="width:150px;" class="btn btn-block btn-primary">View Spouce</button></a>
                    </div>
                    <div style="float:right;" class="col-lg-2 col-sm-4 col-xs-12">
                        ...
                        try{
                            if($_SESSION['ref']==1){
                        ?>
                                <a href="../AdminPannel/DashBoard/principle.php"><button class="btn btn-block ">Done</button></a>
                            <?php }elseif($_SESSION['ref']==5){ ?>
                                <a href="../AdminPannel/DashBoard/teacherAdmin.php"><button class="btn btn-block ">Done</button></a>
                        <?php
                                }
                            }catch(Exception $e) {
                                echo "Button Identification fail!";
                            }
                        ?>
                    </div>
                    <br><br>
                <h1 style="color:#000000;text-align:center;"><strong><em>Manage Spouce Details</em></strong></h1> <br><br>
                <div class="row">
                    <div class="col-md-6">
                        <div style="background-color:#d6ddff;" class="white-box">
                        <h3 class="box-title m-b-0">Spouce Details Form</h3><br>
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form action="" method="post">
                                        <input type="text" class="form-control" id = "Ospname1"  name="Ospname" placeholder="SPOUCE NAME" required>
                                        <br>
                                        <input type="text" class="form-control" id = "Ospscl1"  name="Ospscl" placeholder="SPOUCE SCHOOL" required>
                                        <br>
                                        <?php
                                        try{
                                            if($_SESSION['ref']==1){
                                            ...
                                            echo "Administration Approval Authentication fail!";
                                        }
                                        ?> 
                    ...
                    <div class="col-md-6">
                        ...
                        <h3 class="box-title m-b-0">Important</h3><br>
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <p style="color:#000000;">* Fill this only if your Spouce work on any School in this zone.</p>
                                </div>
