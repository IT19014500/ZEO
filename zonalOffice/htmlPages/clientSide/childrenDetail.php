...
<?php
    try{
        if(isset($_POST['submit'])){
            ...
            $add="INSERT INTO chldserv(chName,coname,profession,tid)VALUES('$TcNamvar','$Tcpnyvar','$Tprofvar','$Ttid')";
            try{
...
<body class="mini-sidebar">
    ...
    <div id="wrapper">
        ...
        try{
            ...
            echo "Navigation Menu Loading Fail!";
        }
        ?>
        <!-- ===== Left-Sidebar-End ===== -->
        <!-- Page Content -->
            ...
            <div class="container-fluid">
                <!-- /row -->
                    <div class="col-lg-2 col-sm-4 col-xs-12">
                        <a href="childList.php"><button style="width:150px;" class="btn btn-block btn-primary">View Children</button></a>
                    </div>
                    <div style="float:right;" class="col-lg-2 col-sm-4 col-xs-12">
                        <a href="spouceDetail.php"><button class="btn btn-block ">Step 11</button></a>
                    </div>
                    <br><br>
                <h1 style="color:#000000;text-align:center;"><strong><em>Manage Children Details</em></strong></h1><br>
                <div class="row">
                    <div class="col-md-6">
                        <div style="background-color:#d6ddff;" class="white-box">
                        <h3 class="box-title m-b-0">Children Details Form</h3><br>
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form action="" method="post">
                                        <input type="text" class="form-control" id = "OcNam1"  name="OcNam" placeholder="CHILD NAME" required>
                                        <br>
                                        <input type="text" class="form-control" id = "Ocpny1"  name="Ocpny" placeholder="ENTER COMPANY" required>
                                        <br>
                                        <input type="text" class="form-control" id = "Oprof1"  name="Oprof" placeholder="ENTER PROFESSION" required>
                                        <br>
                                        <?php
                                            try{
                                                if($_SESSION['ref']==1){
                    ...
                    <div class="col-md-6">
                        ...
                        <h3 class="box-title m-b-0">Important</h3><br>
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <p style="color:#000000;">* Fill this only if your child work on any educational Institute.</p>
                                </div>
