    ...
    if(isset($_POST["import"])){
        ...
        // if($_FILES["file"]["tmp_name"] > 0){
            ...
            while(($column = fgetcsv($file, 0, ",")) !== FALSE){
              ...
              if($column[0]=="distcode"||$column[1]=="distname"||$column[2]=="procode"){
                  continue;
              }
              $sqlinsert = "INSERT INTO districtimport(did,distcode,distname,procode)VALUES('','".$column[0]."','".$column[1]."','".$column[2]."')";
...
<?php
    if(isset($_POST['emptalt'])){
        ...
        $delte="delete from districtimport where did != 0";
...
<?php
    if(isset($_POST["tbimprt"])){
        $sqlds="SELECT * FROM districtimport";
        $resultds=$conn->query($sqlds);
        while($recordds = mysqli_fetch_array($resultds)){
            $ndistcode = $recordds['distcode'];
            $ndistname = $recordds['distname'];
            $nprocode = $recordds['procode'];

            $bzr = "No";

            $endistcode = base64_encode($ndistcode);
            $endistname = base64_encode($ndistname);
            $enprocode = base64_encode($nprocode);

            $sqlcrk="SELECT * FROM district WHERE distcode = '$endistcode'";
            ...
            $add="INSERT INTO district(distcode,distname,procode)VALUES('$endistcode','$endistname','$enprocode')";
        ...
        ?>
        <script>
            alert("Imported into District database sucessfully!");
            location='districtDump.php';
        </script>
        <?php
        exit();
    ...
    <div id="wrapper">
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                <!-- /row -->
                <h1 style="color:#000000;text-align:center;"><strong><em>District List</em></strong></h1> <br><br>
                <div class="row">
                <div class="col-md-6">
                        <div class="white-box">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form action="districtDump.php" method="post" name="uploadCsv" enctype="multipart/form-data">   
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <div class="col-lg-2 col-sm-4 col-xs-12">
                                        <form action="districtDump.php" method="post" >
