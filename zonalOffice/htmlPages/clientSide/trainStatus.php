...
<?php
  if(isset($_POST['submit'])){
    $Ttst=$_POST['Otst'];
    $Ttid=$_POST['Otid'];
    $deeTtst = base64_encode($Ttst);

    $tstts = "No";
    $sqlts="SELECT * FROM tstbl WHERE tid = $Ttid ";
    $resultts=$conn->query($sqlts);
    while($recordts = mysqli_fetch_array($resultts)){
        $tstts = "Yes";
    }
    if($tstts == "No"){
       $add="INSERT INTO tstbl(tid,tsts)VALUES('$Ttid','$deeTtst')";
    }else{
?>

<Script>
  alert("Already added!");
  location='trainStatus.php';
</Script>
<?php
    }
            ...
            <div class="container-fluid">
                <!-- /row -->
                    <div class="col-lg-2 col-sm-4 col-xs-12">
                        <a href="trastsView.php"><button style="width:150px;" class="btn btn-block btn-primary">Status View</button></a>
                    </div>
                    <div style="float:right;" class="col-lg-2 col-sm-4 col-xs-12">
                        <a href="nprteachcs.php"><button class="btn btn-block ">Step 5</button></a>
                    </div>
                    <br><br>
                <h1 style="color:#000000;text-align:center;"><strong><em>Manage Training Status</em></strong></h1> <br><br>
                <div class="row">
                    <div class="col-md-6">
                        <div style="background-color:#d6ddff;" class="white-box">
                        <h3 class="box-title m-b-0">Status Form</h3><br>
                            <!-- <p class="text-muted m-b-30 font-13"></p> -->
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form action="" method="post">
                                        <div align="left">
                                            <select class="form-control" id = "Otst1" name="Otst" required>
                                            <option value="0" selected>-Select Training Status-</option>
