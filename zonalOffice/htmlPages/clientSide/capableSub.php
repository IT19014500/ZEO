...
if(isset($_POST['submit'])){
    ...
    $add="INSERT INTO cpblesub(suID,tid)VALUES('$TsuID','$Ttid')";
...
<Script>
    alert("Capable Subject Added!");
    location='capableSub.php';
</Script>
            ...
            <div class="container-fluid">
                <!-- /row -->
                    <div class="col-lg-2 col-sm-4 col-xs-12">
                        <a href="capableView.php"><button style="width:150px;" class="btn btn-block btn-primary">View Subjects</button></a>
                    </div>
                    <div style="float:right;" class="col-lg-2 col-sm-4 col-xs-12">
                        <a href="trainStatus.php"><button class="btn btn-block ">Step 4</button></a>
                    </div>
                    <br><br>
                <h1 style="color:#000000;text-align:center;"><strong><em>Manage Capable Subject Details</em></strong></h1><br>
                <div class="row">
                    <div class="col-md-6">
                        <div style="background-color:#d6ddff;" class="white-box">
                        <h3 class="box-title m-b-0">Subject Form</h3><br>
