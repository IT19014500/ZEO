    ...
    if(isset($_POST["import"])){
        ...
        // if($_FILES["file"]["tmp_name"] > 0){
            ...
            while(($column = fgetcsv($file, 0, ",")) !== FALSE){
              ...
              if($column[0]=="zonecode"||$column[1]=="zonename"||$column[2]=="distcode"){
                  continue;
              }
              $sqlinsert = "INSERT INTO zonetimport(zoid,zonecode,zonename,distcode)VALUES('','".$column[0]."','".$column[1]."','".$column[2]."')";
...
<?php
    if(isset($_POST['emptalt'])){
        ...
        $delte="delete from zonetimport where zoid != 0";
...
<?php
    if(isset($_POST["tbimprt"])){
        ...
        while($recordds = mysqli_fetch_array($resultds)){
            ...
            $add="INSERT INTO zonet(zone,zonecode,distcode)VALUES('$enzone','$enzonecode','$endistcode')";
        ...
        ?>
        <script>
            alert("Imported into Zone database sucessfully!");
            location='zoneDump.php';
        </script>
        <?php
        exit();
    ...
    <div id="wrapper">
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                <!-- /row -->
                <h1 style="color:#000000;text-align:center;"><strong><em>Zone List</em></strong></h1> <br><br>
                <div class="row">
                <div class="col-md-6">
                        <div class="white-box">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form action="zoneDump.php" method="post" name="uploadCsv" enctype="multipart/form-data">   
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <div class="col-lg-2 col-sm-4 col-xs-12">
                                        <form action="zoneDump.php" method="post" >
