...
<?php
    if(isset($_POST['submit'])){
        ...
        $add="INSERT INTO tvaccationtbl(tid,vid)VALUES('$Ttid','$Tvid')";
...
<Script>
    alert("Vaccation Details Added!");
    location='vaccationAdd.php';
</Script>
            ...
            <div class="container-fluid">
                <!-- /row -->
                    <div class="col-lg-2 col-sm-4 col-xs-12">
                        <a href="vaccList.php"><button class="btn btn-block btn-primary">Vacation List</button></a>
                    </div>
                <h1 style="color:#000000;text-align:center;"><strong><em>Manage Vacation Details</em></strong></h1> <br><br>
                <div class="row">
                    <div class="col-md-4">
                        <div class="white-box">
                        <h3 class="box-title m-b-0">Vaccation Form</h3><br>
                            <!-- <p class="text-muted m-b-30 font-13"></p> -->
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form action="" method="post">
                                        <?php
                                            $sqlvc="SELECT * FROM tvaccation ";
                                            $resultvc=$conn->query($sqlvc);
                                        ?> 
                                        <div align="left">
                                            <select class="form-control" id = "Ovid1" name="Ovid" required>
                                            <option value="0" selected>-Select Vaccation Category-</option>
                                            <?php
                                                while($recordvc = mysqli_fetch_array($resultvc)){  
                                                    $vidt=$recordvc['vid'];
                                                    $envcategoryt=$recordvc['vcategory'];
                                                    $deenvcategoryt = base64_decode($envcategoryt);
                                            ?>
                                                <option value="<?php echo $vidt; ?>" ><?php echo $deenvcategoryt; ?></option>
                                            <?php
                                                }
                                            ?>
                                            </select>
                                        ...
                                        <?php
                                            $sqlmst="SELECT * FROM teacher WHERE scid = $vht && tid IN (SELECT tid FROM ofisign);";
