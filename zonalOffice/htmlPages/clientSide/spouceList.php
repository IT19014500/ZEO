...
<?php 
    try{
        ...
        $ghti = 7;
        $sqlbyta="SELECT * FROM tspoucetmdel";
        ...
        while($recordbyta = mysqli_fetch_array($resultbyta)){
            ...
            $deletebyd="delete from tspoucetmdel where tid= $bytaid";
...
<?php 
        $sqlbytane="SELECT * FROM tspoucetmp";
        ...
        // Add deleting date here
            ...
            $deletebydne="delete from tspoucetmp where tid= $bytaidne";
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="col-lg-2 col-sm-4 col-xs-12">
                    <a href="spouceDetail.php"><button class="btn btn-block btn-primary">Add</button></a>
                </div><br><br>
                <h1 style="color:#000000;text-align:center;"><strong><em>Spouce Details</em></strong></h1> <br><br>
                <div class="row">
                <div class="col-sm-12">
                                        ...
                                        <?php
                                            try{
                                                ...
                                                while($recordbmn = mysqli_fetch_array($resultbmn)){
                                                    $fhg=$recordbmn['tid'];
                                                    $sql3="SELECT * FROM tspouce WHERE tid = $fhg";
                                                    $result3=$conn->query($sql3);
                                        ?>
                                            <?php
                                                while($record3 = mysqli_fetch_array($result3)){
                                                $tbit= $record3['tid'];
                                                $enspname = $record3['spname'];
                                                $enspscl = $record3['spscl'];
                                                ...
                                                $sqljao="SELECT * FROM tspouce where tid = $tbit && tid NOT IN (SELECT tid FROM ofisign);";
                                                $resultjao=$conn->query($sqljao);
                                                while($recordjao = mysqli_fetch_array($resultjao)){
                                                    $balka = "No";
                                                }
                                                $sqlbno="SELECT * FROM tspouce where tid = $tbit && tid IN (SELECT tid FROM tspoucetmp);";
                                                $resultbno=$conn->query($sqlbno);
                                                while($recordbno = mysqli_fetch_array($resultbno)){
                                                    $balka = "ReqEdit";
                                                }

                                                $sqljpo="SELECT * FROM tspouce where tid = $tbit && tid IN (SELECT tid FROM tspoucetmdel);";
                                            ...
                                            ?>
                                                <tr style="color:#000000;background-color:#ffffff;">
                                                    <?php
                                                        if($balka=="No"){
                                                    ?>
                                                        <td><a href="../../Action/spouce/sUpdate.php?id=<?php echo $record3['tid']; ?>"><button class = "btn btn-primary">EDIT</button></a>
                                                        <a href="../../Action/spouce/sDelete.php?id=<?php echo $record3['tid']; ?>"><button class = "btn btn-danger">DELETE</button></a></td>
                                                    <?php
                                                    ...
                                                    <td><?php echo $deenspname; ?></td>
                                                    <td><?php echo $deenspscl; ?></td>
                                                </tr>
                                        <?php
                                                    }
                                                }
