        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="col-lg-2 col-sm-4 col-xs-12">
                    <a href="trainStatus.php"><button class="btn btn-block btn-primary">Add</button></a>
                </div>
                <h1 style="color:#000000;text-align:center;"><strong><em>Training Details</em></strong></h1> <br><br>
                <div class="row">
                <div class="col-sm-12">
                        <div style="background-color:#729ca6;" class="white-box">
                            <h3 class="box-title m-b-0">Training Status</h3>
                            <div class="table-responsive">
                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    ...
                                    <?php
                                        ...
                                        $sql3="SELECT * FROM tstbl WHERE tid = $fhg";
                                        ...
                                        <?php
                                            ...
                                            $sqljao="SELECT * FROM tstbl where tid = $tbit && tid NOT IN (SELECT tid FROM ofisign);";
                                            $resultjao=$conn->query($sqljao);
                                            while($recordjao = mysqli_fetch_array($resultjao)){
                                                $balka = "No";
                                            }
                                            $sqlbno="SELECT * FROM tstbl where tid = $tbit && tid IN (SELECT tid FROM tstbltemp);";
                                            $resultbno=$conn->query($sqlbno);
                                            while($recordbno = mysqli_fetch_array($resultbno)){
                                                $balka = "ReqEdit";
                                            }

                                            $sqljpo="SELECT * FROM tstbl where tid = $tbit && tid IN (SELECT tid FROM tstbltmdel);";
                                        ...
                                        <tr style="color:#000000;background-color:#ffffff;">
                                            ...
                                            <?php
                                                if($balka=="No"){
                                            ?>
                                            <td><a href="../../Action/train/trainUpdate.php?id=<?php echo $tbit; ?>"><button class = "btn btn-primary">EDIT</button></a>
                                            <br><br> <a href="../../Action/train/trainDelete.php?id=<?php echo $tbit; ?>"><button class = "btn btn-danger">DELETE</button></a></td>
                                            <?php
