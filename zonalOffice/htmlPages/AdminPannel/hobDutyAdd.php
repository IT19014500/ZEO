...
<?php
  $sql3="SELECT * FROM duties WHERE iden IN (SELECT iden FROM hobtbl);";
    ...
    <div id="wrapper">
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                <!-- /row -->
                <h1 style="color:#000000;text-align:center;"><strong><em>Manage HOB Duty</em></strong></h1><br>
                <div class="row">
                    <div class="col-sm-4">
                            ...
                            <div align="left">
                                ...
                                <?php
                                    while($recordchg = mysqli_fetch_array($resultchg)){  
                                        ...
                                        $deenmbmem = base64_decode($mbmem);
                                        
                                ?>
                                    <option value="<?php echo $deenmbmem; ?>" ><?php echo $deenmbmem; ?></option>
                                <?php
                                    }
                                ?>
                                </select>
                        ...
                        <div style="background-color:#729ca6;" class="white-box">
                            ...
                            <div class="table-responsive">
                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    <caption style="color:#000000;">Duty Allocation</caption>
                                    <thead>
                                        <tr>
                                            <th>DUID</th>
                                            <th>DUTY</th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr style="color:#000000;background-color:#ffffff;">
                                                ...
                                                <td><a href="../../Action/Duty/dutyUpdate.php?id=<?php echo $record3['duid']; ?>&pgi=<?php echo 'hdp'; ?>"><button class="btn btn-primary">EDIT</button></a></td>
                                                <td><a href="../../Action/Duty/dutyDelete.php?id=<?php echo $record3['duid']; ?>&pgi=<?php echo 'hdp'; ?>"><button class="btn btn-danger">DELETE</button></a></td>
                                            </tr>
                                        <?php
                                            }
                                        ?>
