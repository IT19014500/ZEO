...
<?php
  ...
  $sqlcdr="SELECT * FROM cardret where scid = $vht";
...
$sqlpcrt="SELECT * FROM principle where sgid != 12 AND tid IN (SELECT tid FROM teacher WHERE scid = $vht) ";
$resultpcrt=$conn->query($sqlpcrt);

$princvcnt = mysqli_num_rows($resultpcrt);
// PRINCIPLE COUNT

$sqldeptb="SELECT * FROM teacher where cpro = 3 AND scid = $vht ";
...
$sqlasst="SELECT * FROM teacher where cpro = 4 AND scid = $vht ";
$resultasst=$conn->query($sqlasst);

$asstprivcnt = mysqli_num_rows($resultasst);
//ASSISTANT PRINCIPLE COUNT

$sqlift="SELECT * FROM prcardret where proid = 5 AND scid = $vht ";
$resultift=$conn->query($sqlift);
while($recordift = mysqli_fetch_array($resultift)){
  $addtechcv="Yes";
}

if($addtechcv=="Yes"){
$sqltexh="SELECT * FROM teacher where cpro = 5 AND scid = $vht ";
$resulttexh=$conn->query($sqltexh);

$texhcnt = mysqli_num_rows($resulttexh);
//TEACHER COUNT
}
?>

<?php
$sqlslpa="SELECT * FROM prcardret where scid = $vht";
    ...
    <div id="wrapper">
        ...
        <div style="background-color:#729ca6;" class="page-wrapper">
            <div class="container-fluid">
                <!-- /row -->
                <a href="priCardre.php?prbuid=<?php echo "print"; ?>"><button style="background-color:#0C4574;float:right;margin-right:50px;border-radius:18px;width:120px;height:50px;color:#ffffff;border:none;">Print Mode</button></a>
                <a href="priCardre.php?prbuid=<?php echo "Normal"; ?>"><button style="background-color:#0C4574;float:right;margin-right:30px;border-radius:18px;width:130px;height:50px;color:#ffffff;border:none;">Normal Mode</button></a>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-xs-12">
                                                <form action="" method="post">
                                                    ...
                                                    <div align="left">
                                                        <input type="text" class="form-control" id = "Ocnt1"  name="Ocnt" placeholder="ENTER COUNT" required>
                                                    </div><br>
                                                    <div align="right">
                                            ...
                                            <div class="col-sm-12 col-xs-12">
                                                <form action="" method="post">
                                                    ...
                                                    <div align="right">
                                                        ...
                                                        <input type="reset" class="btn btn-warning" id = "reset2" value="RESET2">
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-12 col-xs-12">
                                                <div class="table-responsive">
                                                    <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                                        ...
                                                        <thead id="tbl23thd">
                                                            <tr>
                                                                <th id="tbl23c1">Subject</th>
                                                                <th id="tbl23c2">Approved</th>
                                                                <th id="tbl23c3">Available</th>
                                                                <th id="tbl23c4">Excess</th>
                                                                <th id="tbl23c5">Defict</th>
                                                                <?php
                                                                if($prboid=="Normal"){
                                                                    ?>
                                                        ...
                                                        ?>
                                                            <tr style="color:#000000;background-color:#ffffff;">
                                                                ...
                                                                <?php
                                                                    $sqlcrd="SELECT * FROM nonprinciple WHERE msubject = $tsubcr && tid IN (SELECT tid FROM teacher where scid = $vht);";
                                                                    ...
                                                                    $sqlactv="SELECT * FROM nonprinciple where msubject = $subjact && tid IN (SELECT tid FROM teacher where scid = $vht);";
                                                                    ...
                                                                    <?php
                                                                        if($prboid=="Normal"){
                                                                    ?>
                                                                    <td><a href="../../../Action/cardre/crdlUpdate.php?id=<?php echo $recordcdr['crid']; ?>"><button class="btn btn-primary"> EDIT </button></a><br><br>
                                                                    <a href="../../../Action/cardre/crdlDelete.php?id=<?php echo $recordcdr['crid']; ?>"><button class="btn btn-danger"> DELETE </button></a></td>
                                                                    <?php
                                                                        }
                                                                    ?>
                                                            </tr>
                                                        ...
                                                        <tfoot>
                                                            <tr>
                                                                ...
                                                                <th id="tbl23f2"><?php echo $totapprbl;?></th>
                                                                <th id="tbl23f3"><?php echo $totavbl;?></th>
                                                                <th id="tbl23f4"><?php echo $totexcebl;?></th>
                                                                <th id="tbl23f5"><?php echo $totdefctbl;?></th>
                                                                <th id="tbl23f6"></th>
                                                            </tr> 
                                                        </tfoot>
                                                    </table><br>
                                            ...
                                            <div class="col-sm-12 col-xs-12">
                                                <div class="table-responsive">
                                                    <table id="example26" class="display nowrap" cellspacing="0" width="100%">
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                <th id="tbl26c1">Proffession</th>
                                                                <th id="tbl26c2">Approved Count</th>
                                                                <th id="tbl26c3">Available Count</th>
                                                                <th id="tbl26c4">Excess</th>
                                                                <th id="tbl26c5">Defict</th>
                                                                <?php
                                                                if($prboid=="Normal"){
                                                                ?>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <?php
                                                                if($prboid=="Normal"){
                                                                    ?>
                                                                <td>
                                                                    <a href="../../../Action/cardre/pricUpdate.php?pid=<?php echo $recordslpa['pcrid']; ?>"><button class="btn btn-primary"> EDIT </button></a><br><br>
                                                                    <a href="../../../Action/cardre/pricDelete.php?pid=<?php echo $recordslpa['pcrid']; ?>"><button class="btn btn-danger"> DELETE </button></a></td>
                                                                <?php
                                                                    }
                                                                ?>
                                                            </tr>
                                                            <?php
                                                                ...
                                                                $avblcpr = $princvcnt+$deprivcnt+$asstprivcnt+$texhcnt;
                                                            ?>
                                                        </tbody>
                                                        <tfoot>
                                                            <tr>
                                                                <th id="tbl26f1">Total</th>
                                                                <th id="tbl26f2"><?php echo $totcntpr;?></th>
                                                                <th id="tbl26f3"><?php echo $avblcpr;?></th>
                                                                <th id="tbl26f4"><?php echo $totexcdf;?></th>
                                                                <th id="tbl26f5"><?php echo $totdefcf;?></th>
                                                            </tr> 
                                                        </tfoot>
                                                    </table>
                                                </div>
