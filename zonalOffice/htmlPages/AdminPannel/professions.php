...
if(isset($_POST['submit'])){
    ...
    $add="INSERT INTO profession(name,des)VALUES('$TfullNamevar','$TaddressTvar')";
...
<Script>
    alert("Profession Details Added!");
    location='professions.php';
    ...
    <div id="wrapper">
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                <!-- /row -->
                <h1 style="color:#000000;text-align:center;"><strong><em>Manage Profession</em></strong></h1><br>
                <div class="row">
                    <div class="col-sm-4">
                        <form action="#" method="post">
                            <div align="left">
                                <input type="text" class="form-control" id = "OfullName1"  name="OfullName" placeholder="ENTER PROFESSION NAME" required>
                            </div><br>
                            <div align="left">
                                <input type="text" class="form-control" id = "OaddressT1"  name="OaddressT" placeholder="ENTER DESCRIPTION" required>
                            </div><br>
                            <div align="right">
                    ...
                    <div class="col-sm-8">
                        <div style="background-color:#729ca6;" class="white-box">
                            <h3 class="box-title m-b-0">Profession List</h3>
                                ...
                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    ...
                                    <?php
                                        while($record3 = mysqli_fetch_array($result3)){
                                            ...
                                            $endes = $record3['des'];
                                            $deendes = base64_decode($endes);
                                    ?>
                                            <tr style="color:#000000;background-color:#ffffff;">
                                                <td><?php echo $record3['proid']; ?></td>
                                                <td><?php echo $deenname; ?></td>
                                                <td><?php echo $deendes; ?></td>
                                                <?php
                                                    if(isset($_SESSION['logged_in']) && $_SESSION['logged_in']==true && $_SESSION['ref']==2){
                                                ?>
                                                <td><a href="../../Action/profession/prUpdate.php?id=<?php echo $record3['proid']; ?>"><button class= "btn btn-primary">EDIT</button></a></td>
                                                <td><a href="../../Action/profession/prDelete.php?id=<?php echo $record3['proid']; ?>"><button class= "btn btn-danger">DELETE</button></a></td>
                                                <?php
                                                    }
                                                ?>
                                            </tr>
