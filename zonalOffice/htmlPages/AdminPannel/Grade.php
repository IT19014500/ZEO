...
<?php
    if(isset($_POST['submit'])){
        ...
        $Tgradevar = base64_encode($Tgrade);
        $Tdescrivar = base64_encode($Tdescri);

        $add="INSERT INTO serandgrade(grade,descri)VALUES('$Tgradevar','$Tdescrivar')";
    ...
    <div id="wrapper">
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                <!-- /row -->
                <h1 style="color:#000000;text-align:center;"><strong><em>Manage Grade Categories</em></strong></h1><br>
                <div class="row">
                    <div class="col-sm-4">
                        <form action="#" method="post">
                            <div align="left">
                                <input type="text" class="form-control" id = "Ograde1"  name="Ograde" placeholder="ENTER GRADE" required>
                            </div><br>
                            <div align="left">
                                <select class="form-control" id = "Odescri1" name="Odescri" placeholder="SELECT CATEGORY" required>
                                    <option value="Not Selected" selected>-Select Category-</option>
                                    <option value="Principle">Principle</option>
                                    <option value="Not Principle" >Not Principle</option>
                                </select>
                            </div><br>
                            <div align="right">
                        ...
                        <div style="background-color:#729ca6;" class="white-box">
                            ...
                            <div class="table-responsive">
                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    <caption style="color:#000000;">Grade List</caption>
                                    <thead>
                                        <tr>
                                            <th>SGID</th>
                                            <th>GRADE</th>
                                    ...
                                    <tbody>
                                        <?php
                                            while($record3 = mysqli_fetch_array($result3)){
                                                $engrade = $record3['grade'];
                                                $endescri = $record3['descri'];
                                                
                                                $deengrade = base64_decode($engrade);
                                                $deendescri = base64_decode($endescri);
                                        ?>
                                            <tr style="color:#000000;background-color:#ffffff;">
                                                <td><?php echo $record3['sgid']; ?></td>
                                                <td><?php echo $deengrade; ?></td>
                                                <td><?php echo $deendescri; ?></td>
                                                <td><a href="../../Action/grade/sgUpdate.php?id=<?php echo $record3['sgid']; ?>"><button class= "btn btn-primary">EDIT</button></a></td>
                                                <?php
                                                    if(isset($_SESSION['logged_in']) && $_SESSION['logged_in']==true && $_SESSION['ref']==2){
                                                ?> 
                                                <td><a href="../../Action/grade/sgDelete.php?id=<?php echo $record3['sgid']; ?>"><button class= "btn btn-danger">DELETE</button></a></td>
                                                <?php
                                                    }
                                                ?>
                                            </tr>
