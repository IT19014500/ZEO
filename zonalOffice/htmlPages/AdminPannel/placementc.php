...
if(isset($_POST['submit'])){
    ...
    $add="INSERT INTO plcategory(name,descri)VALUES('$Tnamevar','$Tdescrivar')";
    ...
    <div id="wrapper">
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                <!-- /row -->
                <h1 style="color:#000000;text-align:center;"><strong><em>Manage Placement Profession</em></strong></h1><br>
                <div class="row">
                    <div class="col-sm-4">
                        <form action="#" method="post">
                            <div align="left">
                                <input type="text" class="form-control" id = "Oname1"  name="Oname" placeholder="ENTER PLACEMENT NAME" required>
                            </div><br>
                            <div align="left">
                    ...
                    <div class="col-sm-8">
                        <div style="background-color:#729ca6;" class="white-box">
                            <h3 class="box-title m-b-0">Placement List</h3>
                                ...
                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    ...
                                    ?>
                                            <tr style="color:#000000;background-color:#ffffff;">
                                                <td><?php echo $record3['plid']; ?></td>
                                                <td><?php echo $deenname; ?></td>
                                                <td><?php echo $deendescri; ?></td>
                                                <td><a href="../../Action/placement/plUpdate.php?id=<?php echo $record3['plid']; ?>"><button class="btn btn-primary">EDIT</button></a></td>
                                                <?php
                                                    if(isset($_SESSION['logged_in']) && $_SESSION['logged_in']==true && $_SESSION['ref']==2){
                                                ?>
                                                <td><a href="../../Action/placement/plDelete.php?id=<?php echo $record3['plid']; ?>"><button class="btn btn-danger">DELETE</button></a></td>
                                                <?php
                                                    }
                                                ?>
                                            </tr>
