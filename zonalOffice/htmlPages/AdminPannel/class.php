...
<?php
    if(isset($_POST['submit'])){
        ...
        $Tclassvar = base64_encode($Tclass);
        $Tdescrivar = base64_encode($Tdescri);


        $add="INSERT INTO classt(class,descri)VALUES('$Tclassvar','$Tdescrivar')";
    ...
    <div id="wrapper">
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                <!-- /row -->
                <h1 style="color:#000000;text-align:center;"><strong><em>Manage Class Number</em></strong></h1><br>
                <div class="row">
                    <div class="col-sm-4">
                        <form action="#" method="post">
                            <div align="left">
                                <input type="text" class="form-control" id = "Oclass1"  name="Oclass" placeholder="ENTER CLASS" required>
                            </div><br>
                            <div align="left">
                        ...
                        <div style="background-color:#729ca6;" class="white-box">
                            ...
                            <div class="table-responsive">
                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    <caption style="color:#000000;">Numerical Number List</caption>
                                    <thead>
                                        <tr>
                                            <th>CLID</th>
                                            <th>CLASS</th>
                                    ...
                                    <tbody>
                                        ...
                                        ?> 
                                            <tr style="color:#000000;background-color:#ffffff;">
                                                <td><?php echo $record3['clid']; ?></td>
                                                <td><?php echo $deenclass; ?></td>
                                                <td><?php echo $deendescri; ?></td>
                                                <td><a href="../../Action/class/clUpdate.php?id=<?php echo $record3['clid']; ?>"><button class="btn btn-primary">EDIT</button></a></td>
                                                <?php
                                                    if(isset($_SESSION['logged_in']) && $_SESSION['logged_in']==true && $_SESSION['ref']==2){
                                                ?>
                                                <td><a href="../../Action/class/clDelete.php?id=<?php echo $record3['clid']; ?>"><button class="btn btn-danger">DELETE</button></a></td>
                                                <?php
                                                    }
                                                ?> 
                                            </tr>
