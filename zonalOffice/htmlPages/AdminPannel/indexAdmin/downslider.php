    ...
    <div id="wrapper">
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                <!-- /row -->
                <h1 style="color:#000000;text-align:center;"><strong><em>Manage Down Slider</em></strong></h1><br>
                <div class="row">
                    <div class="col-sm-4">
                        <form action="" method="post" enctype="multipart/form-data">
                            <input type="text" class="form-control" id = "OfrName1"  name="OfrName" placeholder="ENTER NAME" >
                            <br>
                            <input type="text" class="form-control" id = "Ofrdes1"  name="Ofrdes" placeholder="ENTER DESCRIPTION" >
                            <br>
                    ...
                    <?php
                        try{
                            ...
                            if(isset($_POST['submit']))
                            {
                                ...
                                $tbfrName = $_POST['OfrName'];
                                $tbfrdes = $_POST['Ofrdes'];

                                $tbfrNamevar = base64_encode($tbfrName);
                                $tbfrdesvar = base64_encode($tbfrdes);
                                ...
                                if(isset($_FILES['Osiimg']['name']))
                                {
                                    ...
                                    if($image_name != "")
                                    {
                                        ...
                                        //Rename the image 
                                        $image_name = "IND_Photo_".rand(000,999).'.'.$ext; 

                                        $source_path = $_FILES['Osiimg']['tmp_name'];

                                        $destination_path = "../../../images/index/".$image_name;
                    ...
                    <div class="col-sm-8">
                        <div style="background-color:#729ca6;" class="white-box">
                            <h3 class="box-title m-b-0">Slider List</h3>
                                                ...
                                                if($count>0)
                                                {
                                                    ...
                                                    while($recordtq=mysqli_fetch_assoc($resulttq))
                                                    {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php
                                                                    ...
                                                                    if($image_name!="")
                                                                    {
                                                                        //Dislpay the image
                                                                ?>
                                                                        <img src="<?php echo "../../../images/index/$image_name"; ?>" alt="No Image" style="width:300px" >
                                                                <?php 
                                                                    }
                                                                    else
                                                                    {
                                                            ...
                                                            <td>
                                                                <a href="<?php echo "../../../Action/index/dslUpdate.php?id="?><?php echo $id; ?>" ><button class= "btn btn-primary">Update</button></a> 
                                                            </td>
                                                            <td>
                                                                <a href="<?php echo "../../../Action/index/dslDelete.php?id="?><?php echo $id; ?>&image_name=<?php echo $image_name; ?>" ><button class= "btn btn-danger">Delete</button></a>   
                                                            </td>
                                                        </tr>
                                                        <?php 
                                                    }
