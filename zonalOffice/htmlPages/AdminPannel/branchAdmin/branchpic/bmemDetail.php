...
<?php
try{
  $sqltq="SELECT * FROM bmemtbl ";
  $resulttq=$conn->query($sqltq);

  $count = mysqli_num_rows($resulttq);
}catch(Exception $e) {
    echo "Member List Reading Failed!";
}
?>
    ...
    <div id="wrapper">
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                <!-- /row -->
                <h1 style="color:#000000;text-align:center;"><strong><em>Manage Branch Member Details</em></strong></h1><br>
                <div class="row">
                    <div class="col-sm-4">
                        <form action="#" method="post" enctype="multipart/form-data">
                            ...
                            ?> 
                            <select class="form-control" id = "Obid1" name="Obid" placeholder="ENTER BRANCH ID" required>
                            ...
                            if(isset($_POST['submit']))
                            {
                                ...
                                if(isset($_FILES['Osiimg']['name']))
                                {
                                    ...
                                    if($image_name != "")
                                    {
                                        ...
                                        //Rename the image 
                                        $image_name = "Bmem_Photo_".rand(000,999).'.'.$ext; 

                                        $source_path = $_FILES['Osiimg']['tmp_name'];

                                        $destination_path = "../../../../images/bmemProfile/".$image_name;
                                ...
                                if($res==true)
                                {
                                    ...
                                    echo "<div class='success'>New Member Added Successfully.</div>";
                                    
                                    ?>
                                    
                                    <Script>
                                        alert("Member Added!");
                                        location='bmemDetail.php';
                                    </Script>
                                ...
                                else
                                {
                                    ...
                                    echo "<div class='error'>Failed to Add Member.</div>";
                                }
                    ...
                    <div class="col-sm-8">
                        <div style="background-color:#729ca6;" class="white-box">
                            <h3 class="box-title m-b-0">Member List</h3>
                            <div class="table-responsive">
                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    <caption style="color:#000000;">Member Details</caption>
                                    <thead>
                                        <tr>
                                            <th>Member ID</th>
                                            <th>Branch ID</th>
                                        ...
                                        <?php
                                            try{
                                                ...
                                                if($count>0)
                                                {
                                                    ...
                                                    while($recordtq=mysqli_fetch_assoc($resulttq))
                                                    {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php
                                                                    ...
                                                                    if($image_name!="")
                                                                    {
                                                                        //Dislpay the image
                                                                ?>
                                                                        <img src="<?php echo "../../../../images/bmemProfile/$image_name"; ?>" alt="No Image" style="width:300px" >
                                                                <?php 
                                                                    }
                                                                    else
                                                                    {
                                                            ...
                                                            <td>
                                                                <a href="<?php echo "../../../../Action/bmember/bmemUpdate.php?id="?><?php echo $id; ?>" ><button class="btn btn-primary">Update</button></a> 
                                                            </td>
                                                            <td>
                                                                <a href="<?php echo "../../../../Action/bmember/bmemDelete.php?id="?><?php echo $id; ?>&image_name=<?php echo $image_name; ?>" ><button class="btn btn-danger">Delete</button></a>   
                                                            </td>
                                                        </tr>
                                                ...
                                                else
                                                {
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <td colspan="6"><div class="error">Member Not Added.</div></td>
                                                    </tr>
