...
if(isset($_POST['submit'])){
    ...
    $add="INSERT INTO substream(name)VALUES('$TfullNamevar')";
...
<Script>
    alert("Subject Stream Details Added!");
    location='substreams.php';
    ...
    <div id="wrapper">
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                <!-- /row -->
                <h1 style="color:#000000;text-align:center;"><strong><em>Manage Subject Stream</em></strong></h1><br>
                <div class="row">
                    <div class="col-sm-4">
                        <form action="#" method="post">
                            <div align="left">
                                <input type="text" class="form-control" id = "OfullName1"  name="OfullName" placeholder="ENTER SUBJECT STREAM" required>
                            </div><br>
                            <div align="right">
                                ...
                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    ...
                                    ?>
                                            <tr style="color:#000000;background-color:#ffffff;">
                                                <td><?php echo $record3['ssid']; ?></td>
                                                <td><?php echo $deenname; ?></td>
                                                <td><a href="../../Action/stream/stUpdate.php?id=<?php echo $record3['ssid']; ?>"><button class = "btn btn-primary">EDIT</button></a></td>
                                                <?php
                                                    if(isset($_SESSION['logged_in']) && $_SESSION['logged_in']==true && $_SESSION['ref']==2){
                                                ?>
                                                <td><a href="../../Action/stream/stDelete.php?id=<?php echo $record3['ssid']; ?>"><button class = "btn btn-danger">DELETE</button></a></td>
                                                <?php
                                                    }
                                                ?>
                                            </tr>
