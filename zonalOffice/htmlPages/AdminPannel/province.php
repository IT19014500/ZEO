...
<?php
    if(isset($_POST['submit'])){
        ...
        $add="INSERT INTO provincet(name,procode)VALUES('$Tnamevar','$Tprocodevar')";
...
<Script>
    alert("Province Details Added!");
    location='province.php';
</Script>
    ...
    <div id="wrapper">
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                <!-- /row -->
                <h1 style="color:#000000;text-align:center;"><strong><em>Manage Province</em></strong></h1><br>
                <div class="row">
                    <div class="col-sm-4">
                        <form action="#" method="post">
                            <div align="left">
                                <input type="text" class="form-control" id = "Oname1"  name="Oname" placeholder="ENTER PROVINCE NAME" required>
                            </div><br>
                            <div align="left">
                    ...
                    <div class="col-sm-8">
                        <div style="background-color:#729ca6;" class="white-box">
                            <h3 class="box-title m-b-0">Province List</h3>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr style="color:#000000;background-color:#ffffff;">
                                                ...
                                                <td><a href="../../Action/province/proUpdate.php?id=<?php echo $record3['proid']; ?>"><button class="btn btn-primary">EDIT</button></a></td>
                                                <?php
                                                    if(isset($_SESSION['logged_in']) && $_SESSION['logged_in']==true && $_SESSION['ref']==2){
                                                ?>
                                                <td><a href="../../Action/province/proDelete.php?id=<?php echo $record3['proid']; ?>"><button class= "btn btn-danger">DELETE</button></a></td>
                                                <?php
                                                    }
                                                ?>
                                            </tr>
