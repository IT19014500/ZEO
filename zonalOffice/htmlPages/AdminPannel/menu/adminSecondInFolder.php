...
<!-- <div id="mySidenav" class="sidenav">
  ...
  <a href="../MainAdmin.php">Main Pannel</a>
  <a href="../MainAdminSecond.php">Second Pannel</a>
  <a href="transferReqMan.php">Transfer Requests</a>
  <a href="../cardre/addTeacherNeed.php">Cardre</a>
  <a href="../certificate/cofSelect.php">Certificate Officer</a>
  <a href="../certifyApr.php">Certificate Request</a>
  <a href="../markadmAd.php">Add Mark Admin</a>
</div> -->
                    ...
                    <ul id="side-menu">
                        ...
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li> <a href="../signCollection/officesign.php">Teacher Approval</a> </li>
                            </ul>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li> <a href="transferReqMan.php">Transfer Requests</a> </li>
