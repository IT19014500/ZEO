            ...
            <div class="scroll-sidebar">
                ...
                <nav style="background-color:#ecffec;" class="sidebar-nav">
                    <ul id="side-menu">
                        ...
                        ?>
                        <li>
                            <a href="RowDataAdmin.php" class="active waves-effect" href="javascript:void(0);" aria-expanded="false"><i class="fa fa-square-o" aria-hidden="true"></i>&nbsp&nbsp <span class="hide-menu"> Dashboard </span></a>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="../ExamDuty/dutyProfession.php">Exam Profession</a></li>
                            </ul>
                        </li>
                        <li>
