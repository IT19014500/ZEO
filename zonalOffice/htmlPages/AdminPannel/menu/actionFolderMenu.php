...
$countedil = $countnptu+$countchmp+$countqlmt+$counterml;
$countdell = $counttude+$countchde+$countqlde+$counterde;
                ...
                <div class="user-profile">
                    <div class="dropdown user-pro-body">
                        <div class="profile-image">
                            <img src="../../htmlPages/AdminPannel/jthemes.org/demo-admin/cubic/plugins/images/users/#hanna.jpg" alt="user-img" class="img-circle">
                ...
                <nav style="background-color:#ecffec;" class="sidebar-nav">
                    <ul id="side-menu">
                        ...
                        <!-- <span class="label label-rounded label-info pull-right">3</span> -->
                            <a href="../../htmlPages/AdminPannel/MainAdmin.php" class="active waves-effect" href="javascript:void(0);" aria-expanded="false"><i class="fa fa-square-o" aria-hidden="true"></i>&nbsp&nbsp <span class="hide-menu"> Dashboard </span></a>
                        </li>
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li> <a href="../../htmlPages/AdminPannel/school.php">School List</a> </li>
                                <li> <a href="../../htmlPages/AdminPannel/teacher.php">Teachers</a> </li>
                                <li> <a href="../../htmlPages/AdminPannel/ediitDashboard/headteEdit.php">Edit Requests <span class="label label-rounded label-primary pull-right"><?php if($toteande>0){echo $toteande;}?></span></a> </li>
                                <li> <a href="../../htmlPages/AdminPannel/principleAdd.php">Principal</a> </li>
                                <li> <a href="../../htmlPages/AdminPannel/signCollection/officesign.php">Teacher Approval</a> </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="../../htmlPages/AdminPannel/signCollection/signpic/office.php">Office Sign</a></li>
                                <li><a href="../../htmlPages/AdminPannel/contact/contactDe.php">Contact E-Mail</a></li>
                                <li><a href="../../htmlPages/AdminPannel/userAccountCr.php">User Accounts</a></li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="../../htmlPages/AdminPannel/tReport.php">Transfer Report</a></li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="../../htmlPages/AdminPannel/DashBoard/BranchAdmin.php">Branch Admin</a></li>
                                <li><a href="../../htmlPages/AdminPannel/DashBoard/RowDataAdmin.php">Row Admin</a></li>
                                <li><a href="../../htmlPages/AdminPannel/certificate/cofSelect.php">Certificate Officer</a></li>
                                <li><a href="../../htmlPages/AdminPannel/markadmAd.php">Marking Admin</a></li>
                            </ul>
                        </li>
                        <li>
                            <a class="active waves-effect" href="../../htmlPages/AdminPannel/cardre/addTeacherNeed.php" aria-expanded="false"><i class="fa fa-square-o" aria-hidden="true"></i>&nbsp&nbsp <span class="hide-menu"> Cardre </span></a>
                        </li>
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li> <a href="../../htmlPages/AdminPannel/requests/transferReqMan.php">Transfer Requests</a> </li>
                                <li> <a href="../../htmlPages/AdminPannel/certifyApr.php">Certificate Requests</a> </li>
                            </ul>
                        </li>
                        <li>
                            <a class="active waves-effect" href="../../htmlPages/AdminPannel/cardre/resAnalysis.php" aria-expanded="false"><i class="fa fa-square-o" aria-hidden="true"></i>&nbsp&nbsp <span class="hide-menu"> Result Analysis </span></a>
                        </li>
                    </ul>
                </nav>
            </div>
