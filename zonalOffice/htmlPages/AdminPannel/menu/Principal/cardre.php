            ...
            <div class="scroll-sidebar">
                ...
                <nav style="background-color:#ecffec;" class="sidebar-nav">
                    <ul id="side-menu">
                        ...
                        <li>
                            <a class="active waves-effect" href="../signCollection/principlesign.php" aria-expanded="false"><i class="fa fa-square-o" aria-hidden="true"></i>&nbsp&nbsp <span class="hide-menu"> Approve </span></a>
                        </li>
                        <li>
                            <a class="active waves-effect" href="priCardre.php" aria-expanded="false"><i class="fa fa-square-o" aria-hidden="true"></i>&nbsp&nbsp <span class="hide-menu"> Cadre </span></a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a class="active waves-effect" href="resAnalysis.php" aria-expanded="false"><i class="fa fa-square-o" aria-hidden="true"></i>&nbsp&nbsp <span class="hide-menu"> Result Analysis </span></a>
                        </li>
                    </ul>
                </nav>
            </div>
