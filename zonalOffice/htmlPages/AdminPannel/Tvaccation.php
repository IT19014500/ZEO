...
if(isset($_POST['submit'])){
    ...
    $add="INSERT INTO tvaccation(vcategory,descri)VALUES('$Tvcategoryvar','$Tdescrivar')";
...
<Script>
    alert("Vaccation Category Added!");
    location='Tvaccation.php';
    ...
    <div id="wrapper">
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                <!-- /row -->
                <h1 style="color:#000000;text-align:center;"><strong><em>Manage Vaccation Categories</em></strong></h1><br>
                <div class="row">
                    <div class="col-sm-4">
                        <form action="#" method="post">
                            <div align="left">
                                <input type="text" class="form-control" id = "Ovcategory1"  name="Ovcategory" placeholder="ENTER VACCATION CATEGORY" required>
                            </div><br>
                            <div align="left">
                                <input type="text" class="form-control" id = "Odescri1"  name="Odescri" placeholder="ENTER DESCRIPTION" required>
                            </div><br>
                            <div align="right">
                        ...
                        <div style="background-color:#729ca6;" class="white-box">
                            ...
                            <div class="table-responsive">
                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    <caption style="color:#000000;">Vacations</caption>
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                    ...
                                    <tbody>
                                        <?php
                                            while($record3 = mysqli_fetch_array($result3)){
                                                $envca = $record3['vcategory'];
                                                $deenvca= base64_decode($envca);
                                                
                                                $endescri = $record3['descri'];
                                                $dedescri = base64_decode($endescri);
                                        ?>
                                            <tr style="color:#000000;background-color:#ffffff;">
                                                <td><?php echo $record3['vid']; ?></td>
                                                <td><?php echo $deenvca; ?></td>
                                                <td><?php echo $dedescri; ?></td>
                                                <?php
                                                    if(isset($_SESSION['logged_in']) && $_SESSION['logged_in']==true && $_SESSION['ref']==2){
                                                ?>
                                                <td><a href="../../Action/vaccation/vcaUpdate.php?id=<?php echo $record3['vid']; ?>"><button class= "btn btn-primary">EDIT</button></a></td>
                                                <td><a href="../../Action/vaccation/vcaDelete.php?id=<?php echo $record3['vid']; ?>"><button class= "btn btn-danger">DELETE</button></a></td>
                                                <?php
                                                    }
                                                ?>
                                            </tr>
