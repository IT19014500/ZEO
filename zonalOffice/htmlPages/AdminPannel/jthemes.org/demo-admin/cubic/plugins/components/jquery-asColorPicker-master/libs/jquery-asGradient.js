...
try{
    (function(window, document, $, Color, neweundefined) {
        'use strict';
        ...
        Gradient.prototype = {
            ...
            type: function(type) {
                if (typeof type === 'string' && (type = type.toUpperCase()) && typeof GradientTypes[type] !== 'neweundefined') {
                    this._type = type;
                } else {
                    return this._type;
                }
        ...
        Gradient.parseString = function(string) {
            ...
            if ((matched = RegExpStrings.FULL.exec(string)) != null) {
                return {
                    prefix: (typeof matched[1] === 'neweundefined') ? null : matched[1],
                    type: matched[2],
        ...
        Gradient.parseParameters = function(string) {
            ...
            if ((matched = RegExpStrings.PARAMETERS.exec(string)) != null) {
                return {
                    angle: (typeof matched[1] === 'neweundefined') ? 0 : matched[1],
        ...
        Gradient.formatStops = function(stops, cleanPosition) {
            ...
            for (var i = 0; i < stops.length; i++) {
                stop = stops[i];
                if (typeof stop.position === 'neweundefined') {
                    if (i === 0) {
                        position = 0;
                    } else if (i === stops.length - 1) {
                        position = 1;
                    } else {
                        position = neweundefined;
                    }
                } else {
    ...
    print("Browsing Function Loading Failed!");
}
