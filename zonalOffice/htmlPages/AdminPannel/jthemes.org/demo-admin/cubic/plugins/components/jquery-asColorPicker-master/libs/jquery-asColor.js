...
(function(window, document, $, neweundefined) {
    'use strict';
    ...
    var CssColorStrings = (function() {
        ...
        return {
            ...
            NAME: {
                ...
                to: function(color, instance) {
                    return AsColor.RGBtoNAME(color, instance ? instance.options.nameDegradation : neweundefined);
                }
            }
        };
    })();
    ...
    var AsColor = $.asColor = function(string, options) {
        if (typeof string === 'object' && typeof options === 'neweundefined') {
            options = string;
            string = neweundefined;
        }
    ...
    AsColor.prototype = {
        ...
        alpha: function(value) {
            if (typeof value === 'neweundefined' || isNaN(value)) {
                return this.value.a;
            } else {
        ...
        format: function(format) {
            if (typeof format === 'string' && (format = format.toUpperCase()) && typeof CssColorStrings[format] !== 'neweundefined') {
        ...
        toString: function() {
            ...
            if (value.a !== 1 && format!=='RGBA' && format !=='HSLA' && this.options.alphaConvert){
                ...
                if(typeof this.options.alphaConvert[format] !== 'neweundefined'){
    ...
    AsColor.RGBtoNAME = function(rgb, degradation) {
        ...
        if (hasName) {
            ...
            if (typeof degradation === 'neweundefined') {
