...
<?php
    if(isset($_POST['submit'])){
        ...
        $add="INSERT INTO zonet(zone,zonecode,distcode)VALUES('$Tzonevar','$Tzcodevar','$Tdiscvar')";

        if($conn-> query($add)==TRUE){
?>

<Script>
    alert("Zone Details Added!");
    location='zone.php';
</Script>
    ...
    <div id="wrapper">
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                <!-- /row -->
                <h1 style="color:#000000;text-align:center;"><strong><em>Manage Zone</em></strong></h1><br>
                <div class="row">
                    <div class="col-sm-4">
                        <form action="#" method="post">
                            <input type="text" class="form-control" id = "Ozone1"  name="Ozone" placeholder="ENTER ZONE NAME" required>
                            <br>
                            <input type="text" class="form-control" id = "Ozcode1"  name="Ozcode" placeholder="ENTER ZONE CODE" required>
                            <br>
                            <input type="text" class="form-control" id = "Odisc1"  name="Odisc" placeholder="ENTER DISTRICT CODE" required>
                            <br>
                    ...
                    <div class="col-sm-8">
                        <div style="background-color:#729ca6;" class="white-box">
                            <h3 class="box-title m-b-0">Zone List</h3>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr style="color:#000000;background-color:#ffffff;">
                                                <td><?php echo $record3['zid']; ?></td>
                                                <td><?php echo $deenzone; ?></td>
                                                <td><?php echo $deenzonecode; ?></td>
                                                <td><?php echo $deendistcode; ?></td>
                                                <td><a href="../../Action/zone/zoUpdate.php?id=<?php echo $record3['zid']; ?>"><button class="btn btn-primary">EDIT</button></a></td>
                                                <?php
                                                    if(isset($_SESSION['logged_in']) && $_SESSION['logged_in']==true && $_SESSION['ref']==2){
                                                ?>         
                                                <td><a href="../../Action/zone/zoDelete.php?id=<?php echo $record3['zid']; ?>"><button class="btn btn-danger">DELETE</button></a></td>
                                                <?php
                                                    }
                                                ?>
                                            </tr>
