...
<?php
    if(isset($_POST['submit'])){
        $Tstatus=$_POST['Ostatus'];
        $Tdescri=$_POST['Odescri'];

        $Tstatusvar = base64_encode($Tstatus);
        $Tdescrivar = base64_encode($Tdescri);

        $add="INSERT INTO mstatus(status,descri)VALUES('$Tstatusvar','$Tdescrivar')";
...
<Script>
    alert("Marital Details Added!");
    location='maritaldAdd.php';
    ...
    <div id="wrapper">
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                <!-- /row -->
                <h1 style="color:#000000;text-align:center;"><strong><em>Manage Marital Status</em></strong></h1><br>
                <div class="row">
                    <div class="col-sm-4">
                        <form action="#" method="post">
                            <div align="left">
                                <input type="text" class="form-control" id = "Ostatus1"  name="Ostatus" placeholder="ENTER STATUS" required>
                            </div><br>
                            <div align="left">
                        ...
                        <div style="background-color:#729ca6;" class="white-box">
                            ...
                            <div class="table-responsive">
                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    <caption style="color:#000000;">List with details</caption>
                                    <thead>
                                        <tr>
                                            <th>MRID</th>
                                            <th>STATUS</th>
                                    ...
                                    <tbody>
                                        <?php
                                            while($record3 = mysqli_fetch_array($result3)){
                                                $enstatus = $record3['status'];
                                                $deenstatus = base64_decode($enstatus);
                                        ...
                                        ?>
                                            <tr style="color:#000000;background-color:#ffffff;">
                                                <td><?php echo $record3['mrid']; ?></td>
                                                <td><?php echo $deenstatus; ?></td>
                                                <td><?php echo $deendescri; ?></td>
                                                <td><a href="../../Action/mstatus/mstUpdate.php?id=<?php echo $record3['mrid']; ?>"><button class="btn btn-primary">EDIT</button></a></td>
                                                <?php
                                                    if(isset($_SESSION['logged_in']) && $_SESSION['logged_in']==true && $_SESSION['ref']==2){
                                                ?>
                                                <td><a href="../../Action/mstatus/mstDelete.php?id=<?php echo $record3['mrid']; ?>"><button class="btn btn-danger">DELETE</button></a></td>
                                                <?php
                                                    }
                                                ?>
                                            </tr>
