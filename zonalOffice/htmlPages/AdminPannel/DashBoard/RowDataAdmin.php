<?php
  ...
  session_start();
  if(isset($_SESSION['logged_in']) && $_SESSION['logged_in']==true && $_SESSION['ref']==3 || $_SESSION['ref']==2){
?>

<?php
$sqltq="SELECT * FROM subject ";
$resulttq=$conn->query($sqltq);

$count = mysqli_num_rows($resulttq);

$sqlhod="SELECT * FROM classt ";
$resulthod=$conn->query($sqlhod);

$counthod = mysqli_num_rows($resulthod);

$sqlbme="SELECT * FROM zonet ";
$resultbme=$conn->query($sqlbme);

$countbme = mysqli_num_rows($resultbme);
?>
...
<!-- Mirrored from jthemes.org/demo-admin/cubic/cubic-html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Jun 2022 08:12:59 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="mini-sidebar">
    ...
    <div id="wrapper">
        ...
        <!-- ===== Left-Sidebar ===== -->
        <?php
            require_once '../menu/RowAdmin/RowAdDashboard.php';
        ?>
        <!-- ===== Left-Sidebar-End ===== -->
        <!-- ===== Page-Content ===== -->
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="white-box ecom-stat-widget">
                            <div class="row">
                                <div class="col-xs-6">
                                    <span class="text-blue font-light"><?php echo $count; ?> </i></span>
                    ...
                    <div class="col-md-4">
                        <div class="white-box ecom-stat-widget">
                            <div class="row">
                                <div class="col-xs-6">
                                    <span class="text-blue font-light"><?php echo $counthod; ?> </span>
                                    <p class="font-12">CLASSES</p>
                                </div>
                                <div class="col-xs-6">
                    ...
                    <div class="col-md-4">
                        <div class="white-box ecom-stat-widget">
                            <div class="row">
                                <div class="col-xs-6">
                                    <span class="text-blue font-light"><?php echo $countbme; ?></span>
                                    <p class="font-12">ZONES</p>
                                </div>
                                <div class="col-xs-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 col-sm-9">
                                    <select class="custom-select">
                                        <option selected value="0">Primary</option>
                                        <option value="1">Secondary</option>
                                        <option value="2">Tertary</option>
                                    </select>
