...
<body class="mini-sidebar">
    ...
    <div id="wrapper">
        ...
        <!-- ===== Left-Sidebar ===== -->
        <?php
            require_once '../menu/branchAdmin.php';
        ?>
        <!-- ===== Left-Sidebar-End ===== -->
        <!-- ===== Page-Content ===== -->
                        ...
                        <div class="white-box ecom-stat-widget">
                            <div class="row">
                                <div class="col-xs-6">
                                    ...
                                    <p class="font-12">BRANCH HEADS</p>
                                </div>
                                <div class="col-xs-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 col-sm-9">
                                    <select class="custom-select">
                                        <option selected value="0">HOD</option>
