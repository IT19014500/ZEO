...
<?php
    if(isset($_POST['submit'])){
        ...
        $add="INSERT INTO languages(name,descri)VALUES('$Tnamevar','$Tdescrivar')";
...
<Script>
    alert("Language Details Added!");
    location='languageAdd.php';
    ...
    <div id="wrapper">
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                <!-- /row -->
                <h1 style="color:#000000;text-align:center;"><strong><em>Manage Language Category</em></strong></h1><br>
                <div class="row">
                    <div class="col-sm-4">
                        <form action="#" method="post">
                            <div align="left">
                            <input type="text" class="form-control" id = "Oname1"  name="Oname" placeholder="ENTER LANGUAGE NAME" required>
                            </div><br>
                            <div align="left">
                    ...
                    <div class="col-sm-8">
                        <div style="background-color:#729ca6;" class="white-box">
                            <h3 class="box-title m-b-0">Placement Languages</h3>
                            <div class="table-responsive">
                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    <caption style="color:#000000;">Language List</caption>
                                    <thead>
                                        <tr>
                                            <th>LID</th>
                                            <th>NAME</th>
                                    ...
                                    ?>
                                            <tr style="color:#000000;background-color:#ffffff;">
                                                <td><?php echo $record3['lid']; ?></td>
                                                <td><?php echo $deenname; ?></td>
                                                <td><?php echo $deendescri; ?></td>
                                                <td><a href="../../Action/language/lanUpdate.php?id=<?php echo $record3['lid']; ?>"><button class="btn btn-primary">EDIT</button></a></td>
                                                <?php
                                                    if(isset($_SESSION['logged_in']) && $_SESSION['logged_in']==true && $_SESSION['ref']==2){
                                                ?>          
                                                <td><a href="../../Action/language/lanDelete.php?id=<?php echo $record3['lid']; ?>"><button class="btn btn-danger">DELETE</button></a></td>
                                                <?php
                                                    }
                                                ?>
                                            </tr>
