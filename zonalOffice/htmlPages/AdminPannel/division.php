...
<?php
    if(isset($_POST['submit'])){
        ...
        $Tdivisionname=$_POST['Odivisionname'];
        $Tdistcode=$_POST['Odistcode'];
        $Tzonecode=$_POST['Ozonecode'];

        $Tdivcodevar = base64_encode($Tdivcode);
        $Tdivisionnamevar = base64_encode($Tdivisionname);
        $Tdistcodevar = base64_encode($Tdistcode);
        $Tzonecodevar = base64_encode($Tzonecode);

        $add="INSERT INTO division(divcode,divisionname,distcode,zonecode)VALUES('$Tdivcodevar','$Tdivisionnamevar','$Tdistcodevar','$Tzonecodevar')";

        if($conn-> query($add)==TRUE){
?>

<Script>
    alert("Division Details Added!");
    location='division.php';
</Script>
    ...
    <div id="wrapper">
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                <!-- /row -->
                <h1 style="color:#000000;text-align:center;"><strong><em>Manage Division</em></strong></h1><br>
                <div class="row">
                    <div class="col-sm-4">
                        <form action="#" method="post">
                            <input type="text" class="form-control" id = "Odivcode1"  name="Odivcode" placeholder="ENTER DIVISION CODE" required>
                            <br>
                            <input type="text" class="form-control" id = "Odivisionname1"  name="Odivisionname" placeholder="ENTER DIVISION NAME" required>
                            <br>
                    ...
                    <div class="col-sm-8">
                        <div style="background-color:#729ca6;" class="white-box">
                            <h3 class="box-title m-b-0">Division List</h3>
                                    ...
                                    <tbody>
                                        <?php
                                            while($record3 = mysqli_fetch_array($result3)){
                                                ...
                                                $endivisionname = $record3['divisionname'];
                                                $deendivisionname = base64_decode($endivisionname);
                                        ...
                                        ?>
                                            <tr style="color:#000000;background-color:#ffffff;">
                                                ...
                                                <td><?php echo $deendivisionname; ?></td>
                                                <td><?php echo $deendistcode; ?></td>
                                                <td><?php echo $deenzonecode; ?></td>
                                                <td><a href="../../Action/division/divisUpdate.php?id=<?php echo $endivcode; ?>"><button class="btn btn-primary">EDIT</button></a></td>
                                                <?php
                                                    if(isset($_SESSION['logged_in']) && $_SESSION['logged_in']==true && $_SESSION['ref']==2){
                                                ?>         
                                                <td><a href="../../Action/division/divisDelete.php?id=<?php echo $endivcode; ?>"><button class="btn btn-danger">DELETE</button></a></td>
                                                <?php
                                                    }
                                                ?>
                                            </tr>
