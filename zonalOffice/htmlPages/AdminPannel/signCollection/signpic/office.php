...
<body class="mini-sidebar">
    ...
    <div id="wrapper">
        ...
        <?php
            try{
                require_once '../../menu/topNavigation/officeTPN.php';
            }catch(Exception $e) {
        ...
        <?php
            try{
                require_once '../../menu/office2Folder.php';
            }catch(Exception $e) {
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="white-box">
                            <h3 class="m-b-0 box-title">Upload Sign</h3>
                            <br>
                                ...
                                if(isset($_POST['submit']))
                                {
                                    if(isset($_FILES['Osiimg']['name']))
                                    {
                                        ...
                                        if($image_name != "")
                                        {
                                            ...
                                            //Rename the image 
                                            $image_name = "OFI_Sign_Photo_".rand(000,999).'.'.$ext; 

                                            $source_path = $_FILES['Osiimg']['tmp_name'];

                                            $destination_path = "../../../../images/ofisign/".$image_name;
                                    ...
                                    if($res==true)
                                    {
                                        ...
                                        echo "<div class='success'>New Office Sign Added Successfully.</div>";
                                    ...
                                    else
                                    {
                                        ...
                                        echo "<div class='error'>Failed to Add Office Sign.</div>";
                                    }
                                }
                            }catch(Exception $e) {
                                echo "Insert Failed!";
                                        ...
                                        <?php
                                            try{
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php
                                                            ...
                                                            if($image_name!="")
                                                            {
                                                                ...
                                                                <img src="<?php echo "../../../../images/ofisign/$image_name"; ?>" alt="No Image" style="width:300px" >
                                                                <?php 
                                                            }
                                                            else
                                                            {
                                                    ...
                                                    <td>
                                                        <a href="<?php echo "../../../../Action/onlSign/offisiUpdate.php?id="?><?php echo $id; ?>" ><button class="btn btn-primary">Update</button></a> 
                                                    </td>
                                                    <td>
                                                        <a href="<?php echo "../../../../Action/onlSign/offisiDelete.php?id="?><?php echo $id; ?>&image_name=<?php echo $image_name; ?>" ><button class="btn btn-danger">Delete</button></a>   
                                                    </td>
                                                </tr>
                                                <?php        
                                                    }
                                                ...
                                                ?>
                                                <tr>
                                                    <td colspan="6"><div class="error">No Sign Added.</div></td>
                                                </tr>
                                        <?php
                                                }
                                            }catch(Exception $e) {
                                                echo "Sign Processing Failed!";
                                            }
                                        ?>
                                    </tbody>
                                </table>
