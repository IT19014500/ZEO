...
if(isset($_POST['submit'])){
    ...
    $add="INSERT INTO yeart(yer)VALUES('$Tyer')";
    ...
    <div id="wrapper">
        ...
        <div style="background-color:#acb0bd;" class="page-wrapper">
            <div class="container-fluid">
                <!-- /row -->
                <h1 style="color:#000000;text-align:center;"><strong><em>Manage Year</em></strong></h1><br>
                <div class="row">
                    <div class="col-sm-4">
                        <form action="#" method="post">
                            <div style="float:left;width:330px;">
                                <input type="text" class="form-control" id = "Oyer1"  name="Oyer" placeholder="ENTER YEAR" required>
                            </div><br><br><br>
                                ...
                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    ...
                                    ?>
                                            <tr style="color:#000000;background-color:#ffffff;">
                                                <td><?php echo $record3['YID']; ?></td>
                                                <td><?php echo $enyer; ?></td>
                                                <td><a href="../../Action/year/yerUpdate.php?id=<?php echo $record3['YID']; ?>"><button class = "btn btn-primary">EDIT</button></a></td>
                                                <?php
                                                    if(isset($_SESSION['logged_in']) && $_SESSION['logged_in']==true && $_SESSION['ref']==2){
                                                ?>
                                                <td><a href="../../Action/year/yerDelete.php?id=<?php echo $record3['YID']; ?>"><button class = "btn btn-danger">DELETE</button></a></td>
                                                <?php
                                                    }
                                                ?>
                                            </tr>
